...
== Directory
* `./mesa/demo/mepa_apps/phy_gpio_demo.h` - Header File for GPIO Demo Application
* `./mesa/demo/mepa_apps/phy_gpio_demo.c` - Source File for GPIO Demo Application
...
GPIO Sample Application has following commands to configure the GPIO Pin and events of the PHY.
    ...
    * link:#mesa/demo/docs/gpio-demo@_gpio_mode_configuration[gpio_conf] -- GPIO Pin Mode Configuration
    * link:#mesa/demo/docs/gpio-demo@_gpio_write[gpio_out_set] -- Configure the Value for GPIO Pin
    * link:#mesa/demo/docs/gpio-demo@_gpio_read[gpio_in_get] -- Get the Current value of GPIO Pin
    * link:#mesa/demo/docs/gpio-demo@_gpio_toggle[gpio_toggle] -- Toggle the Current value of GPIO Pin
    * link:#mesa/demo/docs/gpio-demo@_event_set[event_set] -- Enable/Disable the Events
    * link:#mesa/demo/docs/gpio-demo@_event_poll[event_poll] -- Enable the polling and get the events triggered

== GPIO Mode Configuration
GPIO Pin can be configured as *Output* or *Input* or *Alternate Mode* with help of the following Application 
Command.

    * `mesa-cmd PHY GPIO_CONF <port_no>`
...
The Command `gpio_conf` will configure the GPIO Pin as any of the following Mode: +
    ...
    * link:#mesa/demo/docs/gpio-demo@_output_mode_configuration[Output Mode] +
    * link:#mesa/demo/docs/gpio-demo@_input_mode_configuration[Input Mode]  +
    * link:#mesa/demo/docs/gpio-demo@_alternate_mode_configuration[Alternate Function] +
...
Below Command is used to read the current GPIO Value +
    ...
    * `mesa-cmd PHY GPIO_IN_GET <port_no> <gpio_no>`

The Below example Reads the current value of GPIO Pin 3

----
#
# mesa-cmd PHY GPIO_IN_GET 17 3
...
The syntax for command to write GPIO +
    ...
    * `mesa-cmd PHY GPIO_OUT_SET <port_no> <gpio_num> [enable|disable]`

Below example writes 1 to GPIO pin 4

----
#
# mesa-cmd PHY GPIO_OUT_SET 17 4 enable
#
----
...
The syntax for command to toggle GPIO +
    ...
    * `mesa-cmd PHY GPIO_TOGGLE <port_no> <gpio_num>`

Below example toggles GPIO pin 4

----
#
# mesa-cmd PHY GPIO_TOGGLE 1 4
#
----
...
The syntax for command to enable event +
    ...
    * `mesa-cmd PHY Event_set <port_no> <event_list> [enable|disable] [intr_a|intr_b]`

To List the all available arguments in the event_set run the below mentioned command.

----
mesa-cmd PHY Event_set 4 ?
Description:
...
----
#
# mesa-cmd PHY Event_set 4 4,55,88 enable intr_a
...
The syntax for command event_poll +
   * `mesa-cmd PHY Event_poll <port_no> [enable|disable]`

Below example to enable polling on port 1

----
#
# mesa-cmd PHY Event_poll 1 enable
#
----
