...
#define MAKEDWORD(low, high)                                                                       \
    ((uint32_t)(((uint32_t)((uint16_t)(low))) | (((uint32_t)((uint16_t)(high))) << 16UL)))
...
/*Tx_Lpc values*/
typedef enum { eKR_COEF_HOLD, eKR_COEF_INCR, eKR_COEF_DECR } CoeffUpdate_t;
...
typedef struct {
    ...
    uint32_t StatusReportReceivedFromLP : 3; /* Status Report Received From LP
                                                (UPDATED/NOTUPDATED/MIN/MAX)*/
...
static const char *enum_irq_string[] = {
    "AN_RATE",   "GEN1_DONE",       "GEN0_DONE",  "INCP_LINK",   "NP_RX",    "NP_FAIL",
    "ACK_FAIL",  "ABD_FAIL",        "LINK_FAIL",  "AN_GOOD_IRQ", "CMPL_ACK", "AN_RATE_DET",
    "AN_TRAIN",  "AN_XMIT_DISABLE", "DME_VIOL_1", "DME_VIOL_0",  "FRLOCK_1", "FRLOCK_0",
    "REM_RDY_1", "REM_RDY_0",       "BER_BUSY_1", "BER_BUSY_0",  "MW_DONE",  "WT_DONE",
    "LPCVALID",  "LPSVALID",        "KR_ACTV",    "ACK_FIN",     "NP_REQ",
};
