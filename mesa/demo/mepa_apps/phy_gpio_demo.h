...
gpio_table_t viper[MAX_SUPPORTED_ALT_FUN_VIPER] = {
    //  Alt mode    // gpio_no    // Alt Funct
    {0,  0,  "Signal Detect 0"  },
    {1,  1,  "Signal Detect 1"  },
    {2,  2,  "Signal Detect 2"  },
    {3,  3,  "Signal Detect 3"  },
...
gpio_table_t lan8814[MAX_SUPPORTED_ALT_FUN_LAN8814] = {
    //  Alt mode    // gpio_no    // Alt Funct
    {0,  0,  "1588 Event A"   },
    {1,  1,  "1588 Event B"   },
    {2,  2,  "1588 Ref Clk"   },
...
gpio_table_t malibu10g_ch_0[8] = {
    //  Alt mode         //gpio_no      //Alt Function
    {0, 0, "Rate Select"     },
    {1, 1, "Module Absent"   },
