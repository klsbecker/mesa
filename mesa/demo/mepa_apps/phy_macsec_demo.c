...
static mscc_appl_trace_module_t trace_module = {.name = "macsec-demo"};
...
const char *cli_capable_txt(mesa_bool_t enabled) { return (enabled ? "Capable" : "NotCapable"); }
...
const char *cli_enable_txt(int status)
{
    ...
    case 2: return "Bypassed"; break;
    case 3: return "  --"; break;
    case 4: return "Not Triggered"; break;
    case 5: return "Triggered"; break;
    }
    return 0;
}
...
static void cli_cmd_macsec_ena(cli_req_t *req)
{
    ...
    for (int iport = 0; iport < MAX_PORTS; iport++) {
        ...
        if ((rc = mepa_macsec_init_get(meba_macsec_instance->phy_devices[iport], &init_get)) !=
            MEPA_RC_OK) {
        ...
        if ((rc = mepa_macsec_init_set(meba_macsec_instance->phy_devices[iport], &init_data)) !=
            MEPA_RC_OK) {
        ...
        if ((rc = mepa_macsec_default_action_set(meba_macsec_instance->phy_devices[iport], iport,
                                                 &default_action_policy)) != MEPA_RC_OK) {
...
static void cli_cmd_macsec_port_state(cli_req_t *req)
{
    ...
    for (int iport = 0; iport < MAX_PORTS; iport++) {
        ...
        if ((rc = mepa_dev_check(meba_macsec_instance, iport)) != MEPA_RC_OK) {
            capable = 0;
            status = TXT_NOT_APP;
            cli_printf("%-8u%-18s%s\n", port_no, cli_capable_txt(capable), cli_enable_txt(status));
            continue;
        }

        if ((rc = mepa_macsec_is_capable(meba_macsec_instance->phy_devices[iport], iport,
                                         &macsec_capable)) != MEPA_RC_NOT_IMPLEMENTED) {
            capable = macsec_capable;
            if ((rc = mepa_macsec_init_get(meba_macsec_instance->phy_devices[iport], &init_get)) ==
                MEPA_RC_OK) {
                status = (init_get.enable == 1 && init_get.bypass != MEPA_MACSEC_INIT_BYPASS_ENABLE)
                             ? TXT_ENABLED
                             : TXT_DISABLED;
...
static void cli_cmd_secy_create(cli_req_t *req)
{
    ...
    memset(input, '\0', sizeof(input));
    switch (frame_val) {
    case 0:  secy_conf.validate_frames = MEPA_MACSEC_VALIDATE_FRAMES_DISABLED; break;
    case 1:  secy_conf.validate_frames = MEPA_MACSEC_VALIDATE_FRAMES_STRICT; break;
    case 2:  secy_conf.validate_frames = MEPA_MACSEC_VALIDATE_FRAMES_CHECK; break;
    ...
    memset(input, '\0', sizeof(input));
    switch (cipher_sel) {
    case 0:  secy_conf.current_cipher_suite = MEPA_MACSEC_CIPHER_SUITE_GCM_AES_128; break;
    case 1:  secy_conf.current_cipher_suite = MEPA_MACSEC_CIPHER_SUITE_GCM_AES_256; break;
    case 2:  secy_conf.current_cipher_suite = MEPA_MACSEC_CIPHER_SUITE_GCM_AES_XPN_128; break;
    case 3:  secy_conf.current_cipher_suite = MEPA_MACSEC_CIPHER_SUITE_GCM_AES_XPN_256; break;
    ...
    if (mreq->secy_create) {
        if ((rc = mepa_macsec_secy_conf_add(meba_macsec_instance->phy_devices[req->port_no],
                                            macsec_port, &secy_conf)) != MEPA_RC_OK) {
            T_E("\n Error in creating the SecY on port : %d \n", req->port_no);
            return;
        }

        /* SecY Control port enable */
        if ((rc = mepa_macsec_secy_controlled_set(meba_macsec_instance->phy_devices[req->port_no],
                                                  macsec_port, TRUE)) != MEPA_RC_OK) {
            T_E("\n Error in enabling the SecY controlled port on port : %d \n", req->port_no);
            return;
        }
    } else {
        if ((rc = mepa_macsec_secy_conf_update(meba_macsec_instance->phy_devices[req->port_no],
                                               macsec_port, &secy_conf)) != MEPA_RC_OK) {
...
static void cli_cmd_macsec_secy_del(cli_req_t *req)
{
    ...
    if ((rc = mepa_macsec_secy_conf_del(meba_macsec_instance->phy_devices[req->port_no],
                                        macsec_port)) != MEPA_RC_OK) {
...
static void cli_cmd_match_conf(cli_req_t *req)
{
    ...
    cli_printf("\n\n");
    switch (match) {
    case 0: pattern_match.match = MEPA_MACSEC_MATCH_DISABLE; break;
    case 1: pattern_match.match = MEPA_MACSEC_MATCH_DMAC; break;
    case 2: pattern_match.match = MEPA_MACSEC_MATCH_ETYPE; break;
    case 3: pattern_match.match = MEPA_MACSEC_MATCH_SMAC; break;
    case 4: pattern_match.match = MEPA_MACSEC_MATCH_DMAC | MEPA_MACSEC_MATCH_ETYPE; break;
    case 5: pattern_match.match = MEPA_MACSEC_MATCH_SMAC | MEPA_MACSEC_MATCH_ETYPE; break;
    case 6: pattern_match.match = MEPA_MACSEC_MATCH_DMAC | MEPA_MACSEC_MATCH_SMAC; break;
    case 7:
        pattern_match.match =
            MEPA_MACSEC_MATCH_DMAC | MEPA_MACSEC_MATCH_SMAC | MEPA_MACSEC_MATCH_ETYPE;
        break;
    case 8: pattern_match.match = MEPA_MACSEC_MATCH_VLAN_ID | MEPA_MACSEC_MATCH_HAS_VLAN; break;
    case 9:
    ...
    if ((rc = mepa_macsec_pattern_set(meba_macsec_instance->phy_devices[req->port_no], macsec_port,
                                      direction, mreq->match_action, &pattern_match)) !=
        MEPA_RC_OK) {
...
static void cli_cmd_tx_sc_create(cli_req_t *req)
{
    ...
    if ((rc = mepa_macsec_tx_sc_set(meba_macsec_instance->phy_devices[req->port_no],
                                    macsec_port)) != MEPA_RC_OK) {
...
static void cli_cmd_macsec_tx_sc_del(cli_req_t *req)
{
    ...
    /* Tx Secure channel Creation */
    if ((rc = mepa_macsec_tx_sc_del(meba_macsec_instance->phy_devices[req->port_no],
                                    macsec_port)) != MEPA_RC_OK) {
...
static void cli_cmd_rx_sc_create(cli_req_t *req)
{
    ...
    if ((rc = mepa_macsec_secy_conf_get(meba_macsec_instance->phy_devices[req->port_no],
                                        macsec_port, &secy_conf_get)) != MEPA_RC_OK) {
    ...
    if ((rc = mepa_macsec_rx_sc_add(meba_macsec_instance->phy_devices[req->port_no], macsec_port,
                                    &sci)) != MEPA_RC_OK) {
...
static void cli_cmd_macsec_rx_sc_del(cli_req_t *req)
{
    ...
    if ((rc = mepa_macsec_rx_sc_del(meba_macsec_instance->phy_devices[req->port_no], macsec_port,
                                    &sci)) != MEPA_RC_OK) {
...
static void cli_cmd_tx_sa_create(cli_req_t *req)
{
    ...
    if (!req->set) {
        T_E("\n Invalid Syntax\n");
        cli_printf(
            " Syntax : tx_sa_create <port_no> port-id <port_id> an <an_no> next-pn <pn> conf [true|false] \n");
        return;
    }
    if ((rc = mepa_dev_check(meba_macsec_instance, req->port_no)) != MEPA_RC_OK) {
        printf(" Dev is Not Created for the port : %d\n", req->port_no);
    ...
    if (secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_XPN_128 ||
        secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_128) {
    ...
    if (secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_XPN_256 ||
        secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_XPN_128) {
        next_pkt.xpn = mreq->next_pn;
        if ((rc = mepa_macsec_tx_seca_set(meba_macsec_instance->phy_devices[req->port_no],
                                          macsec_port, mreq->an_no, next_pkt, mreq->conf, &sak,
                                          &ssci)) != MEPA_RC_OK) {
        ...
        if ((rc = mepa_macsec_tx_sa_set(meba_macsec_instance->phy_devices[req->port_no],
                                        macsec_port, mreq->an_no, next_pn_nxpn, mreq->conf,
                                        &sak)) != MEPA_RC_OK) {
            T_E("Error is creating Tx Secure asoosiation on port %d\n", (req->port_no + 1));
            return;
        }
    ...
    if ((rc = mepa_macsec_tx_sa_activate(meba_macsec_instance->phy_devices[req->port_no],
                                         macsec_port, mreq->an_no)) != MEPA_RC_OK) {
...
static void cli_cmd_rx_sa_create(cli_req_t *req)
{
    ...
    if (secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_XPN_256 ||
        ...
        if ((rc = mepa_macsec_rx_seca_set(meba_macsec_instance->phy_devices[req->port_no],
                                          macsec_port, &sci, mreq->an_no, next_pkt, &sak, &ssci)) !=
            MEPA_RC_OK) {
        ...
        if ((rc = mepa_macsec_rx_sa_set(meba_macsec_instance->phy_devices[req->port_no],
                                        macsec_port, &sci, mreq->an_no, lowest_pn_nxpn, &sak)) !=
            MEPA_RC_OK) {
            T_E("Error is creating Rx Secure asoosiation on port %d\n", (req->port_no + 1));
            return;
        }
    }
    if ((rc = mepa_macsec_rx_sa_activate(meba_macsec_instance->phy_devices[req->port_no],
                                         macsec_port, &sci, mreq->an_no)) != MEPA_RC_OK) {
...
static void cli_cmd_macsec_tx_sa_del(cli_req_t *req)
{
    ...
    if ((rc = mepa_macsec_tx_sa_del(meba_macsec_instance->phy_devices[req->port_no], macsec_port,
                                    mreq->an_no)) != MEPA_RC_OK) {
...
static void cli_cmd_macsec_rx_sa_del(cli_req_t *req)
{
    ...
    if ((rc = mepa_macsec_rx_sa_del(meba_macsec_instance->phy_devices[req->port_no], macsec_port,
                                    &sci, mreq->an_no)) != MEPA_RC_OK) {
...
static void cli_cmd_rx_sa_pn_update(cli_req_t *req)
{
    ...
    if (secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_XPN_256 ||
        secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_XPN_128) {
        next_pkt.xpn = mreq->lowest_pn;
        if ((rc = mepa_macsec_rx_seca_lowest_pn_update(meba_macsec_instance
                                                           ->phy_devices[req->port_no],
                                                       macsec_port, &sci, mreq->an_no, next_pkt)) !=
            MEPA_RC_OK) {
        ...
        if ((rc =
                 mepa_macsec_rx_sa_lowest_pn_update(meba_macsec_instance->phy_devices[req->port_no],
                                                    macsec_port, &sci, mreq->an_no,
                                                    lowest_pn_nxpn)) != MEPA_RC_OK) {
            T_E("Error is Updating Next PN on port %d\n", (req->port_no + 1));
            return;
        }
    }
...
static void cli_macsec_statistics(const char *col1,
                                  const char *col2,
                                  uint64_t    value1,
                                  uint64_t    value2)
{
...
static void cli_cmd_macsec_secy_statistics(cli_req_t *req)
{
    ...
    if (!mreq->statistics_get) {
        if ((rc = mepa_macsec_secy_counters_clear(meba_macsec_instance->phy_devices[req->port_no],
                                                  macsec_port)) != MEPA_RC_OK) {
    ...
    if ((rc = mepa_macsec_secy_counters_get(meba_macsec_instance->phy_devices[req->port_no],
                                            macsec_port, &counters)) != MEPA_RC_OK) {
    ...
    cli_printf("============================\n");
    cli_macsec_statistics("in_pkts_untagged", "in_pkts_no_tag", counters.in_pkts_untagged,
                          counters.in_pkts_no_tag);
    cli_macsec_statistics("in_pkts_bad_tag", "in_pkts_unknown_sci", counters.in_pkts_bad_tag,
                          counters.in_pkts_unknown_sci);
    cli_macsec_statistics("in_pkts_no_sci", "in_pkts_overrun", counters.in_pkts_no_sci,
                          counters.in_pkts_overrun);
    cli_macsec_statistics("in_octets_validated", "in_octets_decrypted",
                          counters.in_octets_validated, counters.in_octets_decrypted);
    cli_macsec_statistics("out_pkts_untagged", "out_pkts_too_long", counters.out_pkts_untagged,
                          counters.out_pkts_too_long);
    cli_macsec_statistics("out_octets_protected", "out_octets_encrypted",
                          counters.out_octets_protected, counters.out_octets_encrypted);
...
static void cli_cmd_macsec_tx_sc_statistics(cli_req_t *req)
{
    ...
    macsec_port.port_id = mreq->port_id;
    if (!mreq->statistics_get) {
        if ((rc = mepa_macsec_txsc_counters_clear(meba_macsec_instance->phy_devices[req->port_no],
                                                  macsec_port)) != MEPA_RC_OK) {
    ...
    if ((rc = mepa_macsec_tx_sc_counters_get(meba_macsec_instance->phy_devices[req->port_no],
                                             macsec_port, &counters)) != MEPA_RC_OK) {
    ...
    cli_printf("===============================================\n");
    cli_macsec_statistics("out_pkts_protected", "out_pkts_encrypted", counters.out_pkts_protected,
...
static void cli_cmd_macsec_tx_sa_statistics(cli_req_t *req)
{
    ...
    macsec_port.port_id = mreq->port_id;
    if (!mreq->statistics_get) {
        if ((rc = mepa_macsec_txsa_counters_clear(meba_macsec_instance->phy_devices[req->port_no],
                                                  macsec_port, mreq->an_no)) != MEPA_RC_OK) {
    ...
    if ((rc = mepa_macsec_tx_sa_counters_get(meba_macsec_instance->phy_devices[req->port_no],
                                             macsec_port, mreq->an_no, &counters)) != MEPA_RC_OK) {
...
static void cli_cmd_macsec_rx_sc_statistics(cli_req_t *req)
{
    ...
    if (!mreq->statistics_get) {
        if ((rc = mepa_macsec_rxsc_counters_clear(meba_macsec_instance->phy_devices[req->port_no],
                                                  macsec_port, &sci)) != MEPA_RC_OK) {
    ...
    if ((rc = mepa_macsec_rx_sc_counters_get(meba_macsec_instance->phy_devices[req->port_no],
                                             macsec_port, &sci, &counters)) != MEPA_RC_OK) {
    ...
    cli_printf("=================================================\n");
    cli_macsec_statistics("in_pkts_unchecked", "in_pkts_delayed", counters.in_pkts_unchecked,
                          counters.in_pkts_delayed);
    cli_macsec_statistics("in_pkts_late", "in_pkts_ok", counters.in_pkts_late, counters.in_pkts_ok);
    cli_macsec_statistics("in_pkts_invalid", "in_pkts_not_valid", counters.in_pkts_invalid,
                          counters.in_pkts_not_valid);
    cli_macsec_statistics("in_pkts_not_using_sa", "in_pkts_unused_sa",
                          counters.in_pkts_not_using_sa, counters.in_pkts_unused_sa);
    cli_macsec_statistics("in_octets_validated", "in_octets_decrypted",
                          counters.in_octets_validated, counters.in_octets_decrypted);
    return;
}
...
static void cli_cmd_macsec_rx_sa_statistics(cli_req_t *req)
{
    ...
    if (!mreq->statistics_get) {
        if ((rc = mepa_macsec_rxsa_counters_clear(meba_macsec_instance->phy_devices[req->port_no],
                                                  macsec_port, &sci, mreq->an_no)) != MEPA_RC_OK) {
    ...
    if ((rc = mepa_macsec_rx_sa_counters_get(meba_macsec_instance->phy_devices[req->port_no],
                                             macsec_port, &sci, mreq->an_no, &counters)) !=
        MEPA_RC_OK) {
    ...
    cli_printf("===================================================\n");
    cli_macsec_statistics("in_pkts_ok", "in_pkts_invalid", counters.in_pkts_ok,
                          counters.in_pkts_invalid);
    cli_macsec_statistics("in_pkts_not_valid", "in_pkts_not_using_sa", counters.in_pkts_not_valid,
                          counters.in_pkts_not_using_sa);
    cli_macsec_statistics("in_pkts_unchecked", "in_pkts_delayed", counters.in_pkts_unchecked,
                          counters.in_pkts_delayed);
...
static void cli_cmd_macsec_mac_statistics(cli_req_t *req)
{
    ...
    if (!mreq->statistics_get) {
        if (mreq->hmac_counters) {
            if ((rc =
                     mepa_macsec_hmac_counters_clear(meba_macsec_instance->phy_devices[req->port_no],
                                                     req->port_no)) != MEPA_RC_OK) {
                T_E("\n Error in Clearing HMAC Counters on port : %d \n", (req->port_no + 1));
                return;
            }
        } else {
            if ((rc =
                     mepa_macsec_lmac_counters_clear(meba_macsec_instance->phy_devices[req->port_no],
                                                     req->port_no)) != MEPA_RC_OK) {
                T_E("\n Error in Clearing LMAC Counters on port : %d \n", (req->port_no + 1));
                return;
            }
        }
        cli_printf("\n %s Counters cleared on Port : %d\n", mreq->hmac_counters ? "HMAC" : "LMAC",
                   (req->port_no + 1));
        return;
    }
    mepa_macsec_mac_counters_t counters;
    if (mreq->hmac_counters) {
        if ((rc = mepa_macsec_hmac_counters_get(meba_macsec_instance->phy_devices[req->port_no],
                                                req->port_no, &counters, FALSE)) != MEPA_RC_OK) {
        ...
        if ((rc = mepa_macsec_lmac_counters_get(meba_macsec_instance->phy_devices[req->port_no],
                                                req->port_no, &counters, FALSE)) != MEPA_RC_OK) {
    ...
    cli_macsec_statistics("if_rx_octets", "if_rx_in_bytes", counters.if_rx_octets,
                          counters.if_rx_in_bytes);
    cli_macsec_statistics("if_rx_pause_pkts", "if_rx_ucast_pkts", counters.if_rx_pause_pkts,
                          counters.if_rx_ucast_pkts);
    cli_macsec_statistics("if_rx_multicast_pkts", "if_rx_broadcast_pkts",
                          counters.if_rx_multicast_pkts, counters.if_rx_broadcast_pkts);
    cli_macsec_statistics("if_rx_discards", "if_rx_errors", counters.if_rx_discards,
                          counters.if_rx_errors);
    cli_macsec_statistics("if_rx_StatsPkts", "if_rx_CRCAlignErrors", counters.if_rx_StatsPkts,
                          counters.if_rx_CRCAlignErrors);
    cli_macsec_statistics("if_rx_UndersizePkts", "if_rx_OversizePkts", counters.if_rx_UndersizePkts,
                          counters.if_rx_OversizePkts);
    cli_macsec_statistics("if_rx_Fragments", "if_rx_Jabbers", counters.if_rx_Fragments,
                          counters.if_rx_Jabbers);
    cli_macsec_statistics("if_rx_Pkts64Octets", "if_rx_Pkts65to127Octets",
                          counters.if_rx_Pkts64Octets, counters.if_rx_Pkts65to127Octets);
    cli_macsec_statistics("if_rx_Pkts128to255Octets", "if_rx_Pkts256to511Octets",
                          counters.if_rx_Pkts128to255Octets, counters.if_rx_Pkts256to511Octets);
    cli_macsec_statistics("if_rx_Pkts512to1023Octets", "if_rx_Pkts1024to1518Octets",
                          counters.if_rx_Pkts512to1023Octets, counters.if_rx_Pkts1024to1518Octets);
    cli_macsec_statistics("if_rx_Pkts1519toMaxOctets", "NULL", counters.if_rx_Pkts1519toMaxOctets,
                          0);
    cli_printf("\n\n");
    cli_macsec_statistics("if_tx_octets", "if_tx_errors", counters.if_tx_octets,
                          counters.if_tx_errors);
    cli_macsec_statistics("if_tx_pause_pkts", "if_tx_ucast_pkts", counters.if_tx_pause_pkts,
                          counters.if_tx_ucast_pkts);
    cli_macsec_statistics("if_tx_multicast_pkts", "if_tx_broadcast_pkts",
                          counters.if_tx_multicast_pkts, counters.if_tx_broadcast_pkts);
    cli_macsec_statistics("if_tx_StatsPkts", "if_tx_DropEvents", counters.if_tx_StatsPkts,
                          counters.if_tx_DropEvents);
    cli_macsec_statistics("if_tx_Pkts64Octets", "if_tx_Pkts65to127Octets",
                          counters.if_tx_Pkts64Octets, counters.if_tx_Pkts65to127Octets);
    cli_macsec_statistics("if_tx_Pkts128to255Octets", "if_tx_Pkts256to511Octets",
                          counters.if_tx_Pkts128to255Octets, counters.if_tx_Pkts256to511Octets);
    cli_macsec_statistics("if_tx_Pkts512to1023Octets", "if_tx_Pkts1024to1518Octets",
                          counters.if_tx_Pkts512to1023Octets, counters.if_tx_Pkts1024to1518Octets);
    cli_macsec_statistics("if_tx_Pkts1519toMaxOctets", "if_tx_Collisions",
                          counters.if_tx_Pkts1519toMaxOctets, counters.if_tx_Collisions);
    return;
}
...
static void cli_cmd_macsec_vlan_bypass(cli_req_t *req)
{
    ...
    if ((rc = mepa_macsec_bypass_mode_set(meba_macsec_instance->phy_devices[req->port_no],
                                          req->port_no, &bypass_mode)) != MEPA_RC_OK) {
    ...
    case 0:  tag = MEPA_MACSEC_BYPASS_TAG_ZERO; break;
    case 1:  tag = MEPA_MACSEC_BYPASS_TAG_ONE; break;
    case 2:  tag = MEPA_MACSEC_BYPASS_TAG_TWO; break;
    case 3:  tag = MEPA_MACSEC_BYPASS_TAG_THREE; break;
    case 4:  tag = MEPA_MACSEC_BYPASS_TAG_FOUR; break;
    default: tag = MEPA_MACSEC_BYPASS_TAG_ZERO; break;
    }
    mepa_macsec_port_t macsec_port;
    macsec_port.port_no = req->port_no;
    macsec_port.service_id = 0;
    ...
    if ((rc = mepa_macsec_bypass_tag_set(meba_macsec_instance->phy_devices[req->port_no],
                                         macsec_port, tag)) != MEPA_RC_OK) {
        T_E("\n Error in Configuring VLAN Bypass Configuring : %d \n", (req->port_no + 1));
        return;
    }
...
static void cli_cmd_macsec_frame_capt(cli_req_t *req)
{
    ...
    for (int iport = 0; iport < MAX_PORTS; iport++) {
        ...
        if ((rc = mepa_macsec_frame_capture_set(meba_macsec_instance->phy_devices[iport], iport,
                                                frame_capt)) != MEPA_RC_OK) {
...
static void cli_cmd_macsec_frame_get(cli_req_t *req)
{
    ...
    for (int iport = 0; iport < MAX_PORTS; iport++) {
        ...
        if ((rc = mepa_macsec_frame_get(meba_macsec_instance->phy_devices[iport], iport,
                                        MEPA_MACSEC_FRAME_CAPTURE_SIZE_MAX, &frame_length,
                                        &frame[0])) != MEPA_RC_OK) {
...
static void macsec_poll(meba_inst_t inst)
{
    ...
    for (port_no = 0; port_no < MAX_PORTS; port_no++) {
        ...
        mepa_macsec_init_t init_get;
        if ((rc = mepa_macsec_init_get(meba_macsec_instance->phy_devices[port_no], &init_get)) !=
            MEPA_RC_OK) {
            memset(&macsec_status[port_no], 0, sizeof(macsec_status[port_no]));
            continue;
        }
        ...
        if ((rc = mepa_macsec_event_enable_get(meba_macsec_instance->phy_devices[port_no], port_no,
                                               &evt_get)) != MEPA_RC_OK) {
            T_E("\n Error in Polling the MACsec Events on port : %d \n", port_no);
            return;
        }
        switch (evt_get) {
        case MEPA_MACSEC_SEQ_THRESHOLD_EVENT: macsec_status[port_no].seq_thres_event = 1; break;
        case MEPA_MACSEC_SEQ_ROLLOVER_EVENT:  macsec_status[port_no].rollover_event = 1; break;
        ...
        if ((rc = mepa_macsec_event_poll(meba_macsec_instance->phy_devices[port_no], port_no,
                                         &evt_mask)) != MEPA_RC_OK) {
            T_E("\n Error in Polling the MACsec Events on port : %d \n", port_no);
            return;
        }
        switch (evt_mask) {
        case MEPA_MACSEC_SEQ_THRESHOLD_EVENT: macsec_status[port_no].seq_thres_status = 1; break;
        case MEPA_MACSEC_SEQ_ROLLOVER_EVENT:  macsec_status[port_no].rollover_status = 1; break;
        case MEPA_MACSEC_SEQ_ALL:
...
static void cli_cmd_macsec_event_set(cli_req_t *req)
{
    ...
    if (!req->set) {
        T_E("\n Invalid Syntax \n");
        cli_printf(
            " Syntax : macsec event set <port_list> [rollover|seq_threshold] [evt_enable|evt_disable]\n");
        return;
    }
    for (int iport = 0; iport < MAX_PORTS; iport++) {
        port_no = iport2uport(iport);
        ...
        if ((rc = mepa_macsec_event_enable_set(meba_macsec_instance->phy_devices[iport], iport,
                                               event, mreq->enable)) != MEPA_RC_OK) {
...
static void cli_cmd_macsec_event_get(cli_req_t *req)
{
    ...
    for (int iport = 0; iport < MAX_PORTS; iport++) {
        port_no = iport2uport(iport);
        cli_printf("%-10d%-19s%-18s", port_no, cli_enable_txt(macsec_status[iport].rollover_event),
                   cli_enable_txt(macsec_status[iport].seq_thres_event));
...
static void cli_cmd_macsec_seq_num_set(cli_req_t *req)
{
    ...
    for (int iport = 0; iport < MAX_PORTS; iport++) {
        ...
        if (mreq->statistics_get) {
            if ((rc = mepa_macsec_event_seq_threshold_get(meba_macsec_instance->phy_devices[iport],
                                                          iport, &threshold)) != MEPA_RC_OK) {
            ...
            if ((rc = mepa_macsec_event_seq_threshold_set(meba_macsec_instance->phy_devices[iport],
                                                          iport, mreq->seq_threshold_value)) !=
                MEPA_RC_OK) {
...
static void cli_cmd_macsec_conf_get(cli_req_t *req)
{
    ...
    case MACSEC_SECY_CONF_GET:
        ...
        case MEPA_MACSEC_VALIDATE_FRAMES_CHECK:  cli_printf(" Check\n"); break;
        case MEPA_MACSEC_VALIDATE_FRAMES_STRICT: cli_printf(" Strict\n"); break;
        default:                                 cli_printf(" Disabled\n"); break;
        }
        cli_printf("%-25s : %s\n", "Replay protect",
                   secy_conf_get.replay_protect ? "Enabled" : "Disabled");
        cli_printf("%-25s : %d\n", "Replay Window", secy_conf_get.replay_window);
        cli_printf("%-25s : %s\n", "Protect frames",
                   secy_conf_get.protect_frames ? "Enabled" : "Disabled");
        cli_printf("%-25s : %s\n", "always_include_sci",
                   secy_conf_get.always_include_sci ? "Enabled" : "Disabled");
        ...
        case MEPA_MACSEC_CIPHER_SUITE_GCM_AES_128:     cli_printf(" NON-XPN AES-128\n"); break;
        case MEPA_MACSEC_CIPHER_SUITE_GCM_AES_256:     cli_printf(" NON-XPN AES- 256\n"); break;
        case MEPA_MACSEC_CIPHER_SUITE_GCM_AES_XPN_128: cli_printf(" AES -XPN -128\n"); break;
        default:                                       cli_printf(" AES-XPN-256\n"); break;
        }
        cli_printf("%-25s : 0x%x-0x%x-0x%x-0x%x-0x%x-0x%x\n", "Mac Add",
                   secy_conf_get.mac_addr.addr[0], secy_conf_get.mac_addr.addr[1],
                   secy_conf_get.mac_addr.addr[2], secy_conf_get.mac_addr.addr[3],
                   secy_conf_get.mac_addr.addr[4], secy_conf_get.mac_addr.addr[5]);
        break;
    case MACSEC_TX_SC_CONF_GET:
        if ((rc = mepa_macsec_tx_sc_get_conf(meba_macsec_instance->phy_devices[req->port_no],
                                             macsec_port, &tx_sc_conf_get)) != MEPA_RC_OK) {
        ...
        cli_printf("=======================================================================\n");
        cli_printf("%-25s : %s\n", "Protect frames",
                   tx_sc_conf_get.protect_frames ? "Enabled" : "Disabled");
        cli_printf("%-25s : %s\n", "always_include_sci",
                   tx_sc_conf_get.always_include_sci ? "Enabled" : "Disabled");
    ...
    case MACSEC_TX_SA_CONF_GET:
        ...
        if (secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_128 ||
            secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_256) {
            xpn = 0;
            if ((rc = mepa_macsec_tx_sa_get(meba_macsec_instance->phy_devices[req->port_no],
                                            macsec_port, mreq->an_no, &next_pn, &conf, &sak,
                                            &active)) != MEPA_RC_OK) {
            ...
            xpn = 1;
            if ((rc = mepa_macsec_tx_seca_get(meba_macsec_instance->phy_devices[req->port_no],
                                              macsec_port, mreq->an_no, &next_pn_xpn, &conf, &sak,
                                              &active, &ssci)) != MEPA_RC_OK) {
    ...
    case MACSEC_RX_SC_CONF_GET:
        ...
        sci.port_id = mreq->rx_sc_id;
        cli_printf(
            "Rx Secure Channel Configuration for port no %d with port id %d and channel id %d\n",
            req->port_no, mreq->port_id, mreq->rx_sc_id);
        cli_printf(
            "=================================================================================================\n");
        if ((rc = mepa_macsec_rx_sc_get_conf(meba_macsec_instance->phy_devices[req->port_no],
                                             macsec_port, &sci, &rx_sc_conf)) != MEPA_RC_OK) {
            T_E("\n Error in getting the SecY on port : %d \n", (req->port_no + 1));
            return;
        }
        cli_printf("%-25s :", "Frame Validation");
        ...
        cli_printf("%-25s : %s\n", "Replay protect",
                   rx_sc_conf.replay_protect ? "Enabled" : "Disabled");
    ...
    case MACSEC_RX_SA_CONF_GET:
        ...
        if (secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_128 ||
            secy_conf_get.current_cipher_suite == MEPA_MACSEC_CIPHER_SUITE_GCM_AES_256) {
            xpn = 0;
            if ((rc = mepa_macsec_rx_sa_get(meba_macsec_instance->phy_devices[req->port_no],
                                            macsec_port, &sci, mreq->an_no, &next_pn, &sak,
                                            &active)) != MEPA_RC_OK) {
            ...
            xpn = 1;
            if ((rc = mepa_macsec_rx_seca_get(meba_macsec_instance->phy_devices[req->port_no],
                                              macsec_port, &sci, mreq->an_no, &next_pn_xpn, &sak,
                                              &active, &ssci)) != MEPA_RC_OK) {
                T_E("\n Error in getting the Rx SA Conf on port : %d \n", (req->port_no + 1));
                return;
            }
        ...
        cli_printf(
            "Rx Secure Channel Configuration for port no %d with port id %d and channel id %d and an = %d\n",
            (req->port_no + 1), mreq->port_id, mreq->rx_sc_id, mreq->an_no);
        cli_printf(
            "====================================================================================================================\n");
        if (xpn) {
...
static void cli_cmd_cltr_frame_set(cli_req_t *req)
{
    ...
    cli_printf("\n");
    switch (match) {
    case 1:  conf.match = MEPA_MACSEC_MATCH_DMAC; break;
    case 2:  conf.match = MEPA_MACSEC_MATCH_ETYPE; break;
    case 3:  conf.match = MEPA_MACSEC_MATCH_DMAC | MEPA_MACSEC_MATCH_ETYPE; break;
    default: T_E("\n Invalid Match Input\n"); return;
    }
    memcpy(&conf.dmac, &mreq->pattern_dst_mac_addr, sizeof(mreq->pattern_dst_mac_addr));
    conf.etype = mreq->pattern_ethtype;

    if ((rc = mepa_macsec_control_frame_match_conf_set(meba_macsec_instance
                                                           ->phy_devices[req->port_no],
                                                       req->port_no, &conf, NULL)) != MEPA_RC_OK) {
...
static void cli_cmd_cltr_frame_get(cli_req_t *req)
{
    ...
    max_rules =
        (phy_family.family == PHY_FAMILY_MALIBU_25G) ? LAN80XX_MAX_CP_RULES : VSC_PHY_MAX_CP_RULES;
    mepa_macsec_control_frame_match_conf_t conf;
    cli_printf("\n\n Rules configured for 802.1X Control Traffic Bypass on Port %d",
               (req->port_no + 1));
    cli_printf(
        "\n==================================================================================================\n");
    ...
    for (uint32_t i = 0; i < max_rules; i++) {
        if ((rc = mepa_macsec_control_frame_match_conf_get(meba_macsec_instance
                                                               ->phy_devices[req->port_no],
                                                           req->port_no, &conf, i)) != MEPA_RC_OK) {
            T_E("\n Error in Geting Control Match Configuration on port : %d \n",
                (req->port_no + 1));
            return;
        }
        if (conf.match > 1) {
            cli_printf("\n %-10d%-15x%02x-%02x-%02x-%02x-%02x-%02x", i, conf.etype,
                       conf.dmac.addr[0], conf.dmac.addr[1], conf.dmac.addr[2], conf.dmac.addr[3],
                       conf.dmac.addr[4], conf.dmac.addr[5]);
...
static void cli_cmd_cltr_frame_del(cli_req_t *req)
{
    ...
    for (int i = 0; i < mreq->value_cnt; i++) {
        if ((rc = mepa_macsec_control_frame_match_conf_del(meba_macsec_instance
                                                               ->phy_devices[req->port_no],
                                                           req->port_no, mreq->value_list[i])) !=
            MEPA_RC_OK) {
            T_E("\n Error in Geting Control Match Configuration on port : %d \n",
                (req->port_no + 1));
            return;
...
static void cli_cmd_macsec_inst_get(cli_req_t *req)
{
    ...
    for (int iport = 0; iport < MAX_PORTS; iport++) {
        ...
        if ((rc = mepa_macsec_inst_count_get(meba_macsec_instance->phy_devices[iport], iport,
                                             &inst_get)) != MEPA_RC_OK) {
        ...
        for (int i = 0; i < inst_get.no_secy; i++) {
            cli_printf("%    -12d%-13d%-13d", inst_get.secy_vport[i],
                       inst_get.secy_inst_count[i].no_txsc,
                       inst_get.secy_inst_count[i].txsc_inst_count.no_sa);
            ...
            for (int k = 0; k < inst_get.secy_inst_count[i].txsc_inst_count.no_sa; k++) {
                ...
                if (k == (inst_get.secy_inst_count[i].txsc_inst_count.no_sa - 1)) {
                    for (int j = 0;
                         j < (20 - (3 * inst_get.secy_inst_count[i].txsc_inst_count.no_sa)); j++) {
                        cli_printf(" ");
                    }
                }
            }
            ...
            for (int j = 0; j < inst_get.secy_inst_count[i].no_rxsc; j++) {
                cli_printf(" %d (%d),", inst_get.secy_inst_count[i].rx_sci[j].port_id,
                           inst_get.secy_inst_count[i].rxsc_inst_count[j].no_sa);
            }
...
static void cli_cmd_macsec_cmds()
{
    ...
    cli_printf("\n %-20s| %-80s| %s", "macsec port_state", "",
               "Provides MACsec Capability and MACsec State of all Ports");
    cli_printf("\n %-20s| %-80s| %s", "macsec enable", " <port_list> [bypass_none|bypass_disable]",
               "Enables MACsec Block");
    cli_printf("\n %-20s| %-80s| %s", "macsec disable", "<port_list> [bypass_none|bypass_enable]",
               "Disables MACsec Block");
    cli_printf("\n %-20s| %-80s| %s", "secy_create_upd",
               "[create|update] <port_no> port-id <port_id> mac-addr <mac_address>",
               "Create/Update Secure Entity");
    cli_printf("\n %-20s| %-80s| %s", "secy_del", "<port_no> port-id <port_id>",
               "Deletes available Secure Entity");
    cli_printf("\n %-20s| %-80s| %s", "match_conf",
               "<port_no> ethtype <ether_type> src_mac <mac_address> dst_mac <mac_address>",
               "Pattern Matching Params");
    cli_printf("\n %-20s| %-80s| %s", " ", "vlanid <vlan> vid-inner <vlan>", " ");
    cli_printf("\n %-20s| %-80s| %s", "pattern_conf",
               "<port_no> port-id <port_id> [egress|ingress] [cont_port|uncont_port|drop]", " ");
    cli_printf("\n %-20s| %-80s| %s", "tx_sc_create", "<port_no> port-id <port_id>",
               "Transmit Secure Channel Create");
    cli_printf("\n %-20s| %-80s| %s", "rx_sc_create", "<port_no> port-id <port_id> sc-id <id>",
               "Receive Secure Channel Create");
    cli_printf("\n %-20s| %-80s| %s", "tx_sc_del", "<port_no> port-id <port_id>",
               "transmit Secure Channel Delete");
    cli_printf("\n %-20s| %-80s| %s", "rx_sc_del", "<port_no> port-id <port_id> sc-id <id>",
               "Receive Secure Channel Delete");
    cli_printf("\n %-20s| %-80s| %s", "tx_sa_create",
               "<port_no> port-id <port_id> an <an_no> next-pn <pn> conf [true|false]",
               "Transmit Secure Association Create");
    cli_printf("\n %-20s| %-80s| %s", "rx_sa_create",
               "<port_no> port-id <port_id> sc-id <id> an <an_no> lowest-pn <pn>",
               "Receive Secure Association Create");
    cli_printf("\n %-20s| %-80s| %s", "tx_sa_del", "<port_no> port-id <port_id> an <an_no>",
               "Transmit Secure Association Delete");
    cli_printf("\n %-20s| %-80s| %s", "rx_sa_del",
               "<port_no> port-id <port_id> sc-id <id> an <an_no>",
               "Receive Secure Association Delete");
    cli_printf("\n %-20s| %-80s| %s", "rx_sa_pn_upd",
               "<port_no> port-id <port_id> sc-id <id> an <an_no> lowest-pn <pn>",
               "Receive SA Lowest PN Update");
    cli_printf("\n %-20s| %-80s| %s", "statistics secy", "<port_no> port-id <port_id> [get|clear]",
               "SecY Staticstics Get or Clear");
    cli_printf("\n %-20s| %-80s| %s", "statistics tx_sc", "<port_no> port-id <port_id> [get|clear]",
               "Tx Secure Channel Statistics Get or Clear");
    cli_printf("\n %-20s| %-80s| %s", "statistics tx_sa",
               "<port_no> port-id <port_id> an <an_no> [get|clear]",
               "Tx Secure Association Statistics Get or Clear");
    cli_printf("\n %-20s| %-80s| %s", "statistics rx_sc",
               "<port_no> port-id <port_id> sc-id <id> [get|clear]",
               "Rx Secure Channel Statistics Get or Clear");
    cli_printf("\n %-20s| %-80s| %s", "statistics rx_sa",
               "<port_no> port-id <port_id> sc-id <id> an <an_no> [get|clear]",
               "Rx SA Statistics Get or Clear");
    cli_printf("\n %-20s| %-80s| %s", "statistics mac", "[hmac|lmac] <port_no> [get|clear]",
               "HMAC/LMAC Statistics Get or Clear");
    cli_printf("\n %-20s| %-80s| %s", "vlan_bypass",
               "<port_no> port-id <port_id> [zero|one|two|three|four]",
               "Vlan Tag Bypass Configuration");
    cli_printf("\n %-20s| %-80s| %s", "frame capture", "<port_list> [egress|ingress]",
               "MACsec FIFO Frame Capture Configuration");
    cli_printf("\n %-20s| %-80s| %s", "frame get", "<port_list>", "MACsec FIFO Captured Frame Get");
    cli_printf("\n %-20s| %-80s| %s", "macsec event set",
               "<port_list> [rollover|seq_threshold] [evt_enable|evt_disable]",
               "MACsec Event Enable or Disable");
    cli_printf("\n %-20s| %-80s| %s", "macsec event get", "", "MACsec Event Status of all Ports");
    cli_printf("\n %-20s| %-80s| %s", "macsec seq_threshold",
               "[get|set] <port_list> [<threshold_val>]",
               "MACsec Sequence Thresold Val Set or Get");
    cli_printf("\n %-20s| %-80s| %s", "ctrl_frame set",
               "<port_no> ethtype <ether_type> dst_mac <mac_address>",
               "802.1X Control Traffic Bypass Confg Set");
    cli_printf("\n %-20s| %-80s| %s", "ctrl_frame get", "<port_no>",
               "802.1X Control Traffic Bypass Confg Get");
    cli_printf("\n %-20s| %-80s| %s", "ctrl_frame del", "<port_no> <rule_list>",
               "802.1X Control Traffic Bypass Confg Del");
    cli_printf("\n %-20s| %-80s| %s", "conf_get",
               "[secy|tx_sc|tx_sa|rx_sc|rx_sa] <port_no> port-id <port_id> sc-id <id> an <an_no>",
               "Get MACsec Configurations");
    cli_printf("\n\n");
    return;
}
...
static cli_cmd_t cli_cmd_macsec_table[] = {
    {
     "exit_macsec",                                             "Exit MACsec Demo Application",
     cli_cmd_macsec_demo, },
    ...
    {
     "macsec enable <port_list> [bypass_none|bypass_disable]","Enable the MACsec Block",
     cli_cmd_macsec_ena, },

    {
     "macsec disable <port_list> [bypass_none|bypass_enable]",                                                          "Disable the MACsec Block",
     cli_cmd_macsec_dis, },

    {
     "macsec port_state",                                       "Status of MACsec Engine on all Ports",
     cli_cmd_macsec_port_state, },

    {
     "secy_create_upd [create|update] <port_no> port-id <port_id> mac-addr <mac_address>",  "Create or Update the MACsec Secure Entity",
     cli_cmd_secy_create, },

    {
     "secy_del <port_no> port-id <port_id>",                                                        "Delete the Secure Entity",
...

    {
     ...
     "Pattern Match Parameters",                                                                                                                                      cli_cmd_match_param,
     },

    {
     "pattern_conf <port_no> port-id <port_id> [egress|ingress] [cont_port|uncont_port|drop]",                                                          "Pattern Match Configuration",
     cli_cmd_match_conf, },

    {
     "tx_sc_create <port_no> port-id <port_id>",                                      "Transmit Secure Channel Creation",
     cli_cmd_tx_sc_create, },

    {
     "rx_sc_create <port_no> port-id <port_id> sc-id <id>",                    "Receive Secure Channel Creation",
     cli_cmd_rx_sc_create, },

    {
     "tx_sc_del <port_no> port-id <port_id>",                                                        "Delete Transmit Secure Channel",
     cli_cmd_macsec_tx_sc_del, },

    {
     "rx_sc_del <port_no> port-id <port_id> sc-id <id>",                                "Delete Receive Secure Channel",
     cli_cmd_macsec_rx_sc_del, },

    {
     "tx_sa_create <port_no> port-id <port_id> an <an_no> next-pn <pn> conf [true|false]",                                                               "Transmit Secure Assosiation Creation",
     cli_cmd_tx_sa_create, },

    {
     "rx_sa_create <port_no> port-id <port_id> sc-id <id> an <an_no> lowest-pn <pn>",                                       "Receive Secure Assosiation Creation",
     cli_cmd_rx_sa_create, },

    {
     "tx_sa_del <port_no> port-id <port_id> an <an_no>",                "Delete the Transmit Secure Association",
     cli_cmd_macsec_tx_sa_del, },

    {
     "rx_sa_del <port_no> port-id <port_id> sc-id <id> an <an_no>",                                                        "Delete Receive Secure Association",
     cli_cmd_macsec_rx_sa_del, },

    {
     "rx_sa_pn_upd <port_no> port-id <port_id> sc-id <id> an <an_no> lowest-pn <pn>",     "Receive Secure Assosiation Creation",
     cli_cmd_rx_sa_pn_update, },

    {
     "statistics secy <port_no> port-id <port_id> [get|clear]",                                                          "Get or Clear the Secure Entity Statistics",
     cli_cmd_macsec_secy_statistics, },

    {
     "statistics tx_sc <port_no> port-id <port_id> [get|clear]",                                 "Get or Clear Transmit Secure channel Statistics",
     cli_cmd_macsec_tx_sc_statistics, },

    {
     "statistics tx_sa <port_no> port-id <port_id> an <an_no> [get|clear]",        "Get or Clear Transmit Secure Association Statistics",
     cli_cmd_macsec_tx_sa_statistics, },

    {
     "statistics rx_sc <port_no> port-id <port_id> sc-id <id> [get|clear]",                                                        "Get or Clear Receive Secure channel Statistics",
     cli_cmd_macsec_rx_sc_statistics, },

    {
     "statistics rx_sa <port_no> port-id <port_id> sc-id <id> an <an_no> [get|clear]","Get or Clear Receive Secure Association Statistics",
     cli_cmd_macsec_rx_sa_statistics, },

    {
     "statistics mac [hmac|lmac] <port_no> [get|clear]",                                                          "Get or Clear HOST/LINE MAC Statistics",
     cli_cmd_macsec_mac_statistics, },

    {
     "vlan_bypass <port_no> port-id <port_id> [zero|one|two|three|four]",                                     "Configures the Number of VLAN needs to be Bypassed",
     cli_cmd_macsec_vlan_bypass, },

    {
     "frame capture <port_list> [egress|ingress]",        "Enable MACsec FIFO to Capture the Frame",
     cli_cmd_macsec_frame_capt, },

    {
     "frame get <port_list>",                                                        "Read the frame captured in MACsec FIFO",
     cli_cmd_macsec_frame_get, },

    {
     "macsec event set <port_list> [rollover|seq_threshold] [evt_enable|evt_disable]","MACsec Event Configuration",
     cli_cmd_macsec_event_set, },

    {
     "macsec event get",                                                          "Get the Status of MACsec Events",
     cli_cmd_macsec_event_get, },

    {
     "macsec seq_threshold [get|set] <port_list> [<threshold_val>]",                                  "Set/get Packet Number threshold value for MACsec Event",
     cli_cmd_macsec_seq_num_set, },

    {
     "conf_get [secy|tx_sc|tx_sa|rx_sc|rx_sa] <port_no> port-id <port_id> sc-id <id> an <an_no>", "Get the Conf of SecY/SC/SA",
     cli_cmd_macsec_conf_get, },

    {
     "ctrl_frame set <port_no> ethtype <ether_type> dst_mac <mac_address>",                                                        "802.1X Control Traffic Bypass Configuration",
     cli_cmd_cltr_frame_set, },

    {
     "ctrl_frame get <port_no>","Configurations for 802.1X Control Traffic Bypass",
     cli_cmd_cltr_frame_get, },

    {
     "ctrl_frame del <port_no> <rule_list>",                                                          "Delete the Configured rule for 802.1X Control Traffic bypass",
     cli_cmd_cltr_frame_del, },

    {
     "inst_get <port_list>",                          "Indicates number of SecY,SC,SAs created on Physical port",
     cli_cmd_macsec_inst_get, }
};

static cli_cmd_t cli_cmd_table[] = {
    {
     "PHY Macsec", "MACsec Operational Demo",
     cli_cmd_macsec_demo, },
};
...
static cli_parm_t cli_parm_table[] = {
    ...
    {
     "<port_id>",           "Secy identifier",
     CLI_PARM_FLAG_NONE,                                                                                                                                                                                                 cli_cmd_parse_u16_param,
     },

    {
     "<id>",                  "Receive Secure Channel Identifier",
     CLI_PARM_FLAG_NONE,                                                                                                                                                                                                                cli_cmd_parse_u16_param,
     },
...

    {
     ...
     CLI_PARM_FLAG_SET,                                                                                                                                                                                                                                 cli_cmd_parse_mac_addr,
     },

    {
     "<ether_type>",              "Ether-type of Packet",
     CLI_PARM_FLAG_NONE, cli_cmd_parse_u16_param,
     },

    {
     "egress|ingress",                           "Traffic Direction Egress or Ingress",
     CLI_PARM_FLAG_SET,                                                                                                                                                                                                                   cli_cmd_parse_boolean,
     },

    {
     "cont_port|uncont_port|drop",            "Forward Traffic to Controlled/Uncrontrolled Port or Drop Packet",
     CLI_PARM_FLAG_SET,                                                                                                                                                                                                                                 cli_cmd_parse_match_action,
     },
    ...
    {
     "<an_no>",                  "Association Number",
     CLI_PARM_FLAG_NONE,                                          cli_cmd_parse_u16_param,
     },

    {
     "<pn>",                           "Packet Number",
     CLI_PARM_FLAG_SET,                                                                                                                                                                                                         cli_cmd_parse_u64_param,
     },

    {
     "true|false",           "",
     CLI_PARM_FLAG_NO_TXT,                                                                                                                                                                                                            cli_cmd_parse_boolean,
     },
    ...
    {
     "<threshold_val>",                     "Packet Number",
     CLI_PARM_FLAG_SET,                                                                                                                                                                                                                cli_cmd_parse_u64_param,
     },

    {
     "<rule_list>",                            "Control Traffic Rules",
     CLI_PARM_FLAG_SET,                                                                                                                                                                                                                         cli_parm_value_rules,
     },

    {
     "port-id",           "",
     CLI_PARM_FLAG_NO_TXT,                                                                                                                                                                                                                                 cli_cmd_parse_keyword,
     },
...
void mepa_demo_appl_macsec_demo(mscc_appl_init_t *init)
{
    ...
    switch (init->cmd) {
    case MSCC_INIT_CMD_INIT: phy_cli_init(); break;
    default:                 break;
    }
}
