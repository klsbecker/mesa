...
mepa_rc phy_family_detect(meba_inst_t      meba_instance,
                          mepa_port_no_t   port_no,
                          demo_phy_info_t *phy_info)
{
    mepa_rc         rc;
    mepa_phy_info_t phy_info_part;
    if ((rc = mepa_phy_info_get(meba_instance->phy_devices[port_no], &phy_info_part)) !=
        MEPA_RC_OK) {
    ...
    case PHY_TYPE_9131:
        ...
        break;
    case PHY_TYPE_8842:
        phy_info->family = PHY_FAMILY_LAN8842;
        phy_info->family_name = "Pfiffer";
        break;
