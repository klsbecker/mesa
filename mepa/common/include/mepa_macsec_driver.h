...
#ifndef MEPA_MACSEC_DRV_API_H
#define MEPA_MACSEC_DRV_API_H
...
typedef struct mepa_macsec_driver {
    mepa_macsec_init_set_t mepa_driver_macsec_init_set;
    mepa_macsec_init_get_t mepa_driver_macsec_init_get;
    mepa_macsec_secy_conf_add_t mepa_driver_macsec_secy_conf_add;
    mepa_macsec_secy_conf_update_t mepa_driver_macsec_secy_conf_update;
    mepa_macsec_secy_conf_get_t mepa_driver_macsec_secy_conf_get;
    mepa_macsec_secy_conf_del_t mepa_driver_macsec_secy_conf_del;
    mepa_macsec_secy_controlled_set_t mepa_driver_macsec_secy_controlled_set;
    mepa_macsec_secy_controlled_get_t mepa_driver_macsec_secy_controlled_get;
    mepa_macsec_secy_port_status_get_t mepa_driver_macsec_secy_port_status_get;
    mepa_macsec_port_get_next_t mepa_driver_macsec_port_get_next;
    mepa_macsec_rx_sc_add_t mepa_driver_macsec_rx_sc_add;
    mepa_macsec_rx_sc_update_t mepa_driver_macsec_rx_sc_update;
    mepa_macsec_rx_sc_get_conf_t mepa_driver_macsec_rx_sc_get_conf;
    mepa_macsec_rx_sc_get_next_t mepa_driver_macsec_rx_sc_get_next;
    mepa_macsec_rx_sc_del_t mepa_driver_macsec_rx_sc_del;
    mepa_macsec_rx_sc_status_get_t mepa_driver_macsec_rx_sc_status_get;
    mepa_macsec_tx_sc_set_t mepa_driver_macsec_tx_sc_set;
    mepa_macsec_tx_sc_update_t mepa_driver_macsec_tx_sc_update;
    mepa_macsec_tx_sc_get_conf_t mepa_driver_macsec_tx_sc_get_conf;
    mepa_macsec_tx_sc_del_t mepa_driver_macsec_tx_sc_del;
    mepa_macsec_tx_sc_status_get_t mepa_driver_macsec_tx_sc_status_get;
    mepa_macsec_rx_sa_set_t mepa_driver_macsec_rx_sa_set;
    mepa_macsec_rx_sa_get_t mepa_driver_macsec_rx_sa_get;
    mepa_macsec_rx_sa_activate_t mepa_driver_macsec_rx_sa_activate;
    mepa_macsec_rx_sa_disable_t mepa_driver_macsec_rx_sa_disable;
    mepa_macsec_rx_sa_del_t mepa_driver_macsec_rx_sa_del;
    mepa_macsec_rx_sa_lowest_pn_update_t mepa_driver_macsec_rx_sa_lowest_pn_update;
    mepa_macsec_rx_sa_status_get_t mepa_driver_macsec_rx_sa_status_get;
    mepa_macsec_rx_seca_set_t mepa_driver_macsec_rx_seca_set;
    mepa_macsec_rx_seca_get_t mepa_driver_macsec_rx_seca_get;
    mepa_macsec_rx_seca_lowest_pn_update_t mepa_driver_macsec_rx_seca_lowest_pn_update;
    mepa_macsec_tx_sa_set_t mepa_driver_macsec_tx_sa_set;
    mepa_macsec_tx_sa_get_t mepa_driver_macsec_tx_sa_get;
    mepa_macsec_tx_sa_activate_t mepa_driver_macsec_tx_sa_activate;
    mepa_macsec_tx_sa_disable_t mepa_driver_macsec_tx_sa_disable;
    mepa_macsec_tx_sa_del_t mepa_driver_macsec_tx_sa_del;
    mepa_macsec_tx_sa_status_get_t mepa_driver_macsec_tx_sa_status_get;
    mepa_macsec_tx_seca_set_t mepa_driver_macsec_tx_seca_set;
    mepa_macsec_tx_seca_get_t mepa_driver_macsec_tx_seca_get;
    mepa_macsec_controlled_counters_get_t mepa_driver_macsec_controlled_counters_get;
    mepa_macsec_uncontrolled_counters_get_t mepa_driver_macsec_uncontrolled_counters_get;
    mepa_macsec_common_counters_get_t mepa_driver_macsec_common_counters_get;
    mepa_macsec_secy_cap_get_t mepa_driver_macsec_secy_cap_get;
    mepa_macsec_secy_counters_get_t mepa_driver_macsec_secy_counters_get;
    mepa_macsec_counters_update_t mepa_driver_macsec_counters_update;
    mepa_macsec_counters_clear_t mepa_driver_macsec_counters_clear;
    mepa_macsec_rx_sc_counters_get_t mepa_driver_macsec_rx_sc_counters_get;
    mepa_macsec_tx_sc_counters_get_t mepa_driver_macsec_tx_sc_counters_get;
    mepa_macsec_tx_sa_counters_get_t mepa_driver_macsec_tx_sa_counters_get;
    mepa_macsec_rx_sa_counters_get_t mepa_driver_macsec_rx_sa_counters_get;
    mepa_macsec_control_frame_match_conf_set_t mepa_driver_macsec_control_frame_match_conf_set;
    mepa_macsec_control_frame_match_conf_del_t mepa_driver_macsec_control_frame_match_conf_del;
    mepa_macsec_control_frame_match_conf_get_t mepa_driver_macsec_control_frame_match_conf_get;
    mepa_macsec_pattern_set_t mepa_driver_macsec_pattern_set;
    mepa_macsec_pattern_del_t mepa_driver_macsec_pattern_del;
    mepa_macsec_pattern_get_t mepa_driver_macsec_pattern_get;
    mepa_macsec_default_action_set_t mepa_driver_macsec_default_action_set;
    mepa_macsec_default_action_get_t mepa_driver_macsec_default_action_get;
    mepa_macsec_bypass_mode_set_t mepa_driver_macsec_bypass_mode_set;
    mepa_macsec_bypass_mode_get_t mepa_driver_macsec_bypass_mode_get;
    mepa_macsec_bypass_tag_set_t mepa_driver_macsec_bypass_tag_set;
    mepa_macsec_bypass_tag_get_t mepa_driver_macsec_bypass_tag_get;
    mepa_macsec_mtu_set_t mepa_driver_macsec_mtu_set;
    mepa_macsec_mtu_get_t mepa_driver_macsec_mtu_get;
    mepa_macsec_frame_capture_set_t mepa_driver_macsec_frame_capture_set;
    mepa_macsec_frame_get_t mepa_driver_macsec_frame_get;
    mepa_macsec_event_enable_set_t mepa_driver_macsec_event_enable_set;
    mepa_macsec_event_enable_get_t mepa_driver_macsec_event_enable_get;
    mepa_macsec_event_poll_t mepa_driver_macsec_event_poll;
    mepa_macsec_event_seq_threshold_set_t mepa_driver_macsec_event_seq_threshold_set;
    mepa_macsec_event_seq_threshold_get_t mepa_driver_macsec_event_seq_threshold_get;
    mepa_macsec_event_xpn_seq_threshold_set_t mepa_driver_macsec_event_xpn_seq_threshold_set;
    mepa_macsec_event_xpn_seq_threshold_get_t mepa_driver_macsec_event_xpn_seq_threshold_get;
    mepa_macsec_egr_intr_sa_get_t mepa_driver_macsec_egr_intr_sa_get;
    mepa_macsec_csr_read_t mepa_driver_macsec_csr_read;
    mepa_macsec_csr_write_t mepa_driver_macsec_csr_write;
    mepa_macsec_dbg_counter_get_t mepa_driver_macsec_dbg_counter_get;
    mepa_macsec_hmac_counters_get_t mepa_driver_macsec_hmac_counters_get;
    mepa_macsec_lmac_counters_get_t mepa_driver_macsec_lmac_counters_get;
    mepa_macsec_is_capable_t mepa_driver_macsec_is_capable;
    mepa_macsec_dbg_reg_dump_t mepa_driver_macsec_dbg_reg_dump;
    mepa_macsec_inst_count_get_t mepa_driver_macsec_inst_count_get;
    mepa_macsec_lmac_counters_clear_t mepa_driver_macsec_lmac_counters_clear;
    mepa_macsec_hmac_counters_clear_t mepa_driver_macsec_hmac_counters_clear;
    mepa_macsec_debug_counters_clear_t mepa_driver_macsec_debug_counters_clear;
    mepa_macsec_common_counters_clear_t mepa_driver_macsec_common_counters_clear;
    mepa_macsec_uncontrolled_counters_clear_t mepa_driver_macsec_uncontrolled_counters_clear;
    mepa_macsec_controlled_counters_clear_t mepa_driver_macsec_controlled_counters_clear;
    mepa_macsec_rxsa_counters_clear_t mepa_driver_macsec_rxsa_counters_clear;
    mepa_macsec_rxsc_counters_clear_t mepa_driver_macsec_rxsc_counters_clear;
    mepa_macsec_txsa_counters_clear_t mepa_driver_macsec_txsa_counters_clear;
    mepa_macsec_txsc_counters_clear_t mepa_driver_macsec_txsc_counters_clear;
    mepa_macsec_secy_counters_clear_t mepa_driver_macsec_secy_counters_clear;
    mepa_macsec_port_enable_status_get_t mepa_driver_macsec_port_enable_status_get;
    mepa_macsec_rxsa_an_status_get_t mepa_driver_macsec_rxsa_an_status_get;
    mepa_mac_block_mtu_get_t mepa_driver_mac_block_mtu_get;
    mepa_mac_block_mtu_set_t mepa_driver_mac_block_mtu_set;
    mepa_macsec_fcbuf_frame_gap_comp_set_t mepa_driver_macsec_fcbuf_frame_gap_comp_set;
    mepa_macsec_dbg_fcb_block_reg_dump_t mepa_driver_macsec_dbg_fcb_block_reg_dump;
    mepa_macsec_dbg_frm_match_handling_ctrl_reg_dump_t mepa_driver_macsec_dbg_frm_match_handling_ctrl_reg_dump;
#ifdef MEPA_MACSEC_FIFO_OVERFLOW_WORKAROUND
    mepa_macsec_dbg_reconfig_t mepa_driver_macsec_dbg_reconfig;
#endif
    mepa_macsec_dbg_update_seq_set_t mepa_driver_macsec_dbg_update_seq_set;
