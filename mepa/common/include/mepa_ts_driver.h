...
#ifndef MEPA_TS_DRV_API_H
#define MEPA_TS_DRV_API_H
...
typedef struct mepa_ts_driver {
    mepa_ts_init_conf_get_t                 mepa_driver_ts_init_conf_get;
    mepa_ts_init_conf_set_t                 mepa_driver_ts_init_conf_set;
    mepa_ts_mode_get_t                      mepa_driver_ts_mode_get;
    mepa_ts_mode_set_t                      mepa_driver_ts_mode_set;
    mepa_ts_reset_t                         mepa_driver_ts_reset;
    mepa_ts_ltc_ls_en_t                     mepa_driver_ts_ltc_ls_en;
    mepa_ts_ltc_get_t                       mepa_driver_ts_ltc_get;
    mepa_ts_ltc_set_t                       mepa_driver_ts_ltc_set;
    mepa_ts_clock_rateadj_get_t             mepa_driver_ts_clock_rateadj_get;
    mepa_ts_clock_rateadj_set_t             mepa_driver_ts_clock_rateadj_set;
    mepa_ts_clock_adj1ns_t                  mepa_driver_ts_clock_adj1ns;
    mepa_ts_delay_asymmetry_get_t           mepa_driver_ts_delay_asymmetry_get;
    mepa_ts_delay_asymmetry_set_t           mepa_driver_ts_delay_asymmetry_set;
    mepa_ts_path_delay_get_t                mepa_driver_ts_path_delay_get;
    mepa_ts_path_delay_set_t                mepa_driver_ts_path_delay_set;
    mepa_ts_egress_latency_get_t            mepa_driver_ts_egress_latency_get;
    mepa_ts_egress_latency_set_t            mepa_driver_ts_egress_latency_set;
    mepa_ts_ingress_latency_get_t           mepa_driver_ts_ingress_latency_get;
    mepa_ts_ingress_latency_set_t           mepa_driver_ts_ingress_latency_set;
    mepa_ts_pps_conf_set_t                  mepa_driver_ts_pps_conf_set;
    mepa_ts_pps_conf_get_t                  mepa_driver_ts_pps_conf_get;
    mepa_ts_rx_classifier_conf_get_t        mepa_driver_ts_rx_classifier_conf_get;
    mepa_ts_rx_classifier_conf_set_t        mepa_driver_ts_rx_classifier_conf_set;
    mepa_ts_tx_classifier_conf_get_t        mepa_driver_ts_tx_classifier_conf_get;
    mepa_ts_tx_classifier_conf_set_t        mepa_driver_ts_tx_classifier_conf_set;
    mepa_ts_rx_clock_conf_get_t             mepa_driver_ts_rx_clock_conf_get;
    mepa_ts_tx_clock_conf_get_t             mepa_driver_ts_tx_clock_conf_get;
    mepa_ts_rx_clock_conf_set_t             mepa_driver_ts_rx_clock_conf_set;
    mepa_ts_tx_clock_conf_set_t             mepa_driver_ts_tx_clock_conf_set;
    mepa_ts_stats_get_t                     mepa_driver_ts_stats_get;
    mepa_ts_event_get_t                     mepa_driver_ts_event_get;
    mepa_ts_event_set_t                     mepa_driver_ts_event_set;
    mepa_ts_event_poll_t                    mepa_driver_ts_event_poll;
    mepa_ts_test_config_t                   mepa_driver_ts_test_config;
    mepa_ts_fifo_read_install_t             mepa_driver_ts_fifo_read_install;
    mepa_ts_fifo_empty_t                    mepa_driver_ts_fifo_empty;
    mepa_ts_fifo_entry_get_t                mepa_driver_ts_fifo_get;
    mepa_ts_fifo_signature_set_t            mepa_driver_ts_fifo_signature_set;
    mepa_ts_fifo_signature_get_t            mepa_driver_ts_fifo_signature_get;
    mepa_ts_pch_mch_error_info_get_t        mepa_driver_ts_pch_mch_error_info_get;
    mepa_ts_csr_reg_read_t                  mepa_driver_ts_csr_reg_read;
    mepa_ts_csr_reg_write_t                 mepa_driver_ts_csr_reg_write;
} mepa_ts_driver_t;
