...
mepa_tc10_driver_t lan8770_tc10_drivers = {
    .mepa_driver_tc10_set_sleep_support           = lan8770_tc10_set_sleep_support,
    .mepa_driver_tc10_get_sleep_support           = lan8770_tc10_get_sleep_support,
    .mepa_driver_tc10_set_wakeup_support          = lan8770_tc10_set_wakeup_support,
    .mepa_driver_tc10_get_wakeup_support          = lan8770_tc10_get_wakeup_support,
    .mepa_driver_tc10_set_wakeup_fwd_support      = lan8770_tc10_set_wakeup_fwd_support,
    .mepa_driver_tc10_get_wakeup_fwd_support      = lan8770_tc10_get_wakeup_fwd_support,
    .mepa_driver_tc10_set_wake_pin_polarity       = lan8770_tc10_set_wake_pin_polarity,
    .mepa_driver_tc10_get_wake_pin_polarity       = lan8770_tc10_get_wake_pin_polarity,
    .mepa_driver_tc10_set_pin_mode                = lan8770_tc10_set_pin_mode,
    .mepa_driver_tc10_get_pin_mode                = lan8770_tc10_get_pin_mode,
    .mepa_driver_tc10_send_sleep_request          = lan8770_tc10_send_sleep_request,
    .mepa_driver_tc10_get_state                   = lan8770_tc10_get_state,
    .mepa_driver_tc10_send_wake_request           = lan8770_tc10_send_wake_request,
};
