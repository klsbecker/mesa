...
mepa_ts_driver_t lan80xx_ts_drivers = {
    .mepa_driver_ts_reset                      = lan80xx_ts_reset,
    .mepa_driver_ts_init_conf_get              = lan80xx_ts_init_conf_get,
    .mepa_driver_ts_init_conf_set              = lan80xx_ts_init_conf_set,
    .mepa_driver_ts_mode_get                   = lan80xx_ts_mode_get,
    .mepa_driver_ts_mode_set                   = lan80xx_ts_mode_set,
    .mepa_driver_ts_tx_classifier_conf_set     = lan80xx_ts_tx_classifier_conf_set,
    .mepa_driver_ts_tx_classifier_conf_get     = lan80xx_ts_tx_classifier_conf_get,
    .mepa_driver_ts_rx_classifier_conf_set     = lan80xx_ts_rx_classifier_conf_set,
    .mepa_driver_ts_rx_classifier_conf_get     = lan80xx_ts_rx_classifier_conf_get,
    .mepa_driver_ts_tx_clock_conf_set          = lan80xx_ts_tx_clock_conf_set,
    .mepa_driver_ts_tx_clock_conf_get          = lan80xx_ts_tx_clock_conf_get,
    .mepa_driver_ts_rx_clock_conf_set          = lan80xx_ts_rx_clock_conf_set,
    .mepa_driver_ts_rx_clock_conf_get          = lan80xx_ts_rx_clock_conf_get,
    .mepa_driver_ts_fifo_read_install          = lan80xx_ts_fifo_read_install,
    .mepa_driver_ts_fifo_empty                 = lan80xx_ts_fifo_empty,
    .mepa_driver_ts_fifo_get                   = lan80xx_ts_fifo_get,
    .mepa_driver_ts_ltc_get                    = lan80xx_ts_ltc_get,
    .mepa_driver_ts_ltc_set                    = lan80xx_ts_ltc_set,
    .mepa_driver_ts_ltc_ls_en                  = lan80xx_ts_ltc_ls_en,
    .mepa_driver_ts_delay_asymmetry_get        = lan80xx_ts_clock_delay_asymmetry_get,
    .mepa_driver_ts_delay_asymmetry_set        = lan80xx_ts_clock_delay_asymmetry_set,
    .mepa_driver_ts_path_delay_get             = lan80xx_ts_clock_path_delay_get,
    .mepa_driver_ts_path_delay_set             = lan80xx_ts_clock_path_delay_set,
    .mepa_driver_ts_clock_rateadj_get          = lan80xx_ts_clock_rateadj_get,
    .mepa_driver_ts_clock_rateadj_set          = lan80xx_ts_clock_rateadj_set,
    .mepa_driver_ts_egress_latency_get         = lan80xx_ts_clock_egress_latency_get,
    .mepa_driver_ts_egress_latency_set         = lan80xx_ts_clock_egress_latency_set,
    .mepa_driver_ts_ingress_latency_get        = lan80xx_ts_clock_ingress_latency_get,
    .mepa_driver_ts_ingress_latency_set        = lan80xx_ts_clock_ingress_latency_set,
    .mepa_driver_ts_pps_conf_set               = lan80xx_ts_pps_conf_set,
    .mepa_driver_ts_clock_adj1ns               = NULL,
    .mepa_driver_ts_pps_conf_get               = lan80xx_ts_pps_conf_get,
    .mepa_driver_ts_stats_get                  = lan80xx_ts_stats_get,
    .mepa_driver_ts_event_get                  = lan80xx_ts_event_get,
    .mepa_driver_ts_event_set                  = lan80xx_ts_event_set,
    .mepa_driver_ts_event_poll                 = lan80xx_ts_event_poll,
    .mepa_driver_ts_fifo_signature_set         = lan80xx_phy_ts_fifo_sig_set,
    .mepa_driver_ts_fifo_signature_get         = lan80xx_phy_ts_fifo_sig_get,
    .mepa_driver_ts_csr_reg_read               = lan80xx_phy_ts_csr_read,
    .mepa_driver_ts_csr_reg_write              = lan80xx_phy_ts_csr_write,
};
