...
mepa_macsec_driver_t lan80xx_macsec_drivers = {
    .mepa_driver_macsec_init_set                     = lan80xx_macsec_init_set,
    .mepa_driver_macsec_init_get                     = lan80xx_macsec_init_get,
    .mepa_driver_macsec_is_capable                   = lan80xx_macsec_is_capable,
    .mepa_driver_macsec_default_action_set           = lan80xx_macsec_default_action_set,
    .mepa_driver_macsec_default_action_get           = lan80xx_macsec_default_action_get,
    .mepa_driver_macsec_secy_conf_add                = lan80xx_macsec_secy_conf_add,
    .mepa_driver_macsec_secy_conf_get                = lan80xx_macsec_secy_conf_get,
    .mepa_driver_macsec_secy_conf_del                = lan80xx_macsec_secy_conf_del,
    .mepa_driver_macsec_secy_conf_update             = lan80xx_macsec_secy_conf_update,
    .mepa_driver_macsec_secy_controlled_set          = lan80xx_macsec_secy_controlled_set,
    .mepa_driver_macsec_secy_controlled_get          = lan80xx_macsec_secy_controlled_get,
    .mepa_driver_macsec_pattern_set                  = lan80xx_macsec_pattern_set,
    .mepa_driver_macsec_pattern_get                  = lan80xx_macsec_pattern_get,
    .mepa_driver_macsec_pattern_del                  = lan80xx_macsec_pattern_del,
    .mepa_driver_macsec_tx_sc_set                    = lan80xx_macsec_tx_sc_set,
    .mepa_driver_macsec_tx_sc_update                 = lan80xx_macsec_tx_sc_update,
    .mepa_driver_macsec_tx_sc_del                    = lan80xx_macsec_tx_sc_del,
    .mepa_driver_macsec_tx_sc_status_get             = lan80xx_macsec_tx_sc_status_get,
    .mepa_driver_macsec_tx_sc_get_conf               = lan80xx_macsec_tx_sc_get_conf,
    .mepa_driver_macsec_rx_sc_add                    = lan80xx_macsec_rx_sc_add,
    .mepa_driver_macsec_rx_sc_update                 = lan80xx_macsec_rx_sc_update,
    .mepa_driver_macsec_rx_sc_get_conf               = lan80xx_macsec_rx_sc_get_conf,
    .mepa_driver_macsec_rx_sc_status_get             = lan80xx_macsec_rx_sc_status_get,
    .mepa_driver_macsec_rx_sc_del                    = lan80xx_macsec_rx_sc_del,
    .mepa_driver_macsec_tx_sa_set                    = lan80xx_macsec_tx_sa_set,
    .mepa_driver_macsec_tx_sa_get                    = lan80xx_macsec_tx_sa_get,
    .mepa_driver_macsec_tx_sa_del                    = lan80xx_macsec_tx_sa_del,
    .mepa_driver_macsec_tx_sa_activate               = lan80xx_macsec_tx_sa_activate,
    .mepa_driver_macsec_tx_sa_disable                = lan80xx_macsec_tx_sa_disable,
    .mepa_driver_macsec_tx_sa_status_get             = lan80xx_macsec_tx_sa_status_get,
    .mepa_driver_macsec_tx_seca_set                  = lan80xx_macsec_tx_seca_set,
    .mepa_driver_macsec_tx_seca_get                  = lan80xx_macsec_tx_seca_get,
    .mepa_driver_macsec_rx_sa_set                    = lan80xx_macsec_rx_sa_set,
    .mepa_driver_macsec_rx_sa_get                    = lan80xx_macsec_rx_sa_get,
    .mepa_driver_macsec_rx_sa_activate               = lan80xx_macsec_rx_sa_activate,
    .mepa_driver_macsec_rx_sa_disable                = lan80xx_macsec_rx_sa_disable,
    .mepa_driver_macsec_rx_sa_del                    = lan80xx_macsec_rx_sa_del,
    .mepa_driver_macsec_rx_sa_status_get             = lan80xx_macsec_rx_sa_status_get,
    .mepa_driver_macsec_rx_seca_set                  = lan80xx_macsec_rx_seca_set,
    .mepa_driver_macsec_rx_seca_get                  = lan80xx_macsec_rx_seca_get,
    .mepa_driver_macsec_rx_sa_lowest_pn_update       = lan80xx_macsec_rx_sa_lowest_pn_update,
    .mepa_driver_macsec_rxsa_an_status_get           = lan80xx_macsec_rxsa_an_status_get,
    .mepa_driver_macsec_port_enable_status_get       = lan80xx_macsec_port_enable_status_get,
    .mepa_driver_macsec_secy_counters_get            = lan80xx_macsec_secy_counters_get,
    .mepa_driver_macsec_tx_sa_counters_get           = lan80xx_macsec_tx_sa_counters_get,
    .mepa_driver_macsec_tx_sc_counters_get           = lan80xx_macsec_tx_sc_counters_get,
    .mepa_driver_macsec_rx_sa_counters_get           = lan80xx_macsec_rx_sa_counters_get,
    .mepa_driver_macsec_rx_sc_counters_get           = lan80xx_macsec_rx_sc_counters_get,
    .mepa_driver_macsec_uncontrolled_counters_get    = NULL,
    .mepa_driver_macsec_uncontrolled_counters_clear  = NULL,
    .mepa_driver_macsec_common_counters_get          = NULL,
    .mepa_driver_macsec_common_counters_clear        = NULL,
    .mepa_driver_macsec_controlled_counters_get      = NULL,
    .mepa_driver_macsec_controlled_counters_clear    = NULL,
    .mepa_driver_macsec_txsc_counters_clear          = lan80xx_macsec_txsc_counters_clear,
    .mepa_driver_macsec_txsa_counters_clear          = lan80xx_macsec_txsa_counters_clear,
    .mepa_driver_macsec_rxsc_counters_clear          = lan80xx_macsec_rxsc_counters_clear,
    .mepa_driver_macsec_rxsa_counters_clear          = lan80xx_macsec_rxsa_counters_clear,
    .mepa_driver_macsec_secy_counters_clear          = lan80xx_macsec_secy_counters_clear,
    .mepa_driver_macsec_counters_update              = lan80xx_macsec_counters_update,
    .mepa_driver_macsec_lmac_counters_get            = lan80xx_macsec_lmac_counters_get,
    .mepa_driver_macsec_hmac_counters_get            = lan80xx_macsec_hmac_counters_get,
    .mepa_driver_macsec_lmac_counters_clear          = lan80xx_macsec_lmac_counters_clear,
    .mepa_driver_macsec_hmac_counters_clear          = lan80xx_macsec_hmac_counters_clear,
    .mepa_driver_macsec_csr_read                     = lan80xx_macsec_csr_read,
    .mepa_driver_macsec_csr_write                    = lan80xx_macsec_csr_write,
    .mepa_driver_macsec_mtu_set                      = lan80xx_macsec_mtu_set,
    .mepa_driver_macsec_mtu_get                      = lan80xx_macsec_mtu_get,
    .mepa_driver_mac_block_mtu_set                   = lan80xx_mac_block_mtu_set,
    .mepa_driver_mac_block_mtu_get                   = lan80xx_mac_block_mtu_get,
    .mepa_driver_macsec_frame_capture_set            = lan80xx_macsec_frame_capture_set,
    .mepa_driver_macsec_frame_get                    = lan80xx_macsec_frame_get,
    .mepa_driver_macsec_event_seq_threshold_set      = lan80xx_macsec_event_seq_threshold_set,
    .mepa_driver_macsec_event_seq_threshold_get      = lan80xx_macsec_event_seq_threshold_get,
    .mepa_driver_macsec_event_xpn_seq_threshold_set  = lan80xx_macsec_event_xpn_seq_threshold_set,
    .mepa_driver_macsec_event_xpn_seq_threshold_get  = lan80xx_macsec_event_xpn_seq_threshold_get,
    .mepa_driver_macsec_control_frame_match_conf_set = lan80xx_macsec_control_frame_match_conf_set,
    .mepa_driver_macsec_control_frame_match_conf_del = lan80xx_macsec_control_frame_match_conf_del,
    .mepa_driver_macsec_control_frame_match_conf_get = lan80xx_macsec_control_frame_match_conf_get,
    .mepa_driver_macsec_secy_cap_get                 = lan80xx_macsec_secy_cap_get,
    .mepa_driver_macsec_event_enable_set             = lan80xx_macsec_event_enable_set,
    .mepa_driver_macsec_event_enable_get             = lan80xx_macsec_event_enable_get,
    .mepa_driver_macsec_event_poll                   = lan80xx_macsec_event_poll,
    .mepa_driver_macsec_port_get_next                = lan80xx_macsec_port_get_next,
    .mepa_driver_macsec_bypass_mode_set              = lan80xx_macsec_bypass_mode_set,
    .mepa_driver_macsec_bypass_mode_get              = lan80xx_macsec_bypass_mode_get,
    .mepa_driver_macsec_bypass_tag_set               = lan80xx_macsec_bypass_tag_set,
    .mepa_driver_macsec_bypass_tag_get               = lan80xx_macsec_bypass_tag_get,
    .mepa_driver_macsec_inst_count_get               = lan80xx_macsec_inst_count_get,
    .mepa_driver_macsec_dbg_counter_get              = lan80xx_macsec_dbg_counter_get,
    .mepa_driver_macsec_debug_counters_clear         = lan80xx_macsec_debug_counters_clear,
    .mepa_driver_macsec_dbg_reg_dump                 = lan80xx_macsec_dbg_reg_dump,
    .mepa_driver_macsec_dbg_update_seq_set           = lan80xx_macsec_dbg_update_seq_set,
};
