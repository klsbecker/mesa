...
static mepa_rc lan8814_ts_rx_classifier_conf_set_priv(mepa_device_t *dev, uint16_t flow_index, const mepa_ts_classifier_t *const pkt_conf)
{
    ...
    case MEPA_TS_ENCAP_ETH_PTP:
        ...
        if (pkt_conf->eth_class_conf.mac_match_select == MEPA_TS_ETH_MATCH_SRC_ADDR) {
            ...
            if (data->dev.rev < LAN8814_REV_D || pkt_conf->eth_class_conf.mac_match_select != MEPA_TS_ETH_MATCH_NONE) {
...
mepa_ts_driver_t lan8814_ts_drivers = {
    .mepa_driver_ts_init_conf_get              = lan8814_ts_init_conf_get,
    .mepa_driver_ts_init_conf_set              = lan8814_ts_init_conf_set,
    .mepa_driver_ts_mode_get                   = lan8814_ts_mode_get,
    .mepa_driver_ts_mode_set                   = lan8814_ts_mode_set,
    .mepa_driver_ts_reset                      = lan8814_ts_reset,
    .mepa_driver_ts_ltc_ls_en                  = lan8814_ts_ltc_ls_en_set,
    .mepa_driver_ts_ltc_get                    = lan8814_ts_ltc_get,
    .mepa_driver_ts_ltc_set                    = lan8814_ts_ltc_set,
    .mepa_driver_ts_clock_rateadj_get          = lan8814_ts_clock_rateadj_get,
    .mepa_driver_ts_clock_rateadj_set          = lan8814_ts_clock_rateadj_set,
    .mepa_driver_ts_clock_adj1ns               = lan8814_ts_clock_adj1ns,
    .mepa_driver_ts_delay_asymmetry_get        = lan8814_ts_clock_delay_asymmetry_get,
    .mepa_driver_ts_delay_asymmetry_set        = lan8814_ts_clock_delay_asymmetry_set,
    .mepa_driver_ts_path_delay_get             = lan8814_ts_clock_path_delay_get,
    .mepa_driver_ts_path_delay_set             = lan8814_ts_clock_path_delay_set,
    .mepa_driver_ts_egress_latency_get         = lan8814_ts_clock_egress_latency_get,
    .mepa_driver_ts_egress_latency_set         = lan8814_ts_clock_egress_latency_set,
    .mepa_driver_ts_ingress_latency_get        = lan8814_ts_clock_ingress_latency_get,
    .mepa_driver_ts_ingress_latency_set        = lan8814_ts_clock_ingress_latency_set,
    .mepa_driver_ts_rx_classifier_conf_get     = lan8814_ts_rx_classifier_conf_get,
    .mepa_driver_ts_rx_classifier_conf_set     = lan8814_ts_rx_classifier_conf_set,
    .mepa_driver_ts_tx_classifier_conf_get     = lan8814_ts_tx_classifier_conf_get,
    .mepa_driver_ts_tx_classifier_conf_set     = lan8814_ts_tx_classifier_conf_set,
    .mepa_driver_ts_rx_clock_conf_get          = lan8814_ts_rx_ptp_clock_conf_get,
    .mepa_driver_ts_tx_clock_conf_get          = lan8814_ts_tx_ptp_clock_conf_get,
    .mepa_driver_ts_rx_clock_conf_set          = lan8814_ts_rx_ptp_clock_conf_set,
    .mepa_driver_ts_tx_clock_conf_set          = lan8814_ts_tx_ptp_clock_conf_set,
    .mepa_driver_ts_pps_conf_get               = lan8814_ts_pps_conf_get,
    .mepa_driver_ts_pps_conf_set               = lan8814_ts_pps_conf_set,
    .mepa_driver_ts_stats_get                  = lan8814_ts_stats_get,
    .mepa_driver_ts_event_get                  = lan8814_ts_event_get,
    .mepa_driver_ts_event_set                  = lan8814_ts_event_set,
    .mepa_driver_ts_event_poll                 = lan8814_ts_event_poll,
    .mepa_driver_ts_fifo_read_install          = lan8814_ts_fifo_read_install,
    .mepa_driver_ts_fifo_empty                 = lan8814_ts_tx_ts_get,
    .mepa_driver_ts_test_config                = lan8814_ts_test_config,
    .mepa_driver_ts_fifo_get                   = lan8814_ts_fifo_get,
    .mepa_driver_ts_pch_mch_error_info_get     = lan8814_ts_pch_mch_error_get,
};
