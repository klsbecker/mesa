...
mepa_ts_driver_t vtss_ts_drivers = {
    .mepa_driver_ts_init_conf_get          = vtss_ts_init_conf_get,
    .mepa_driver_ts_init_conf_set          = vtss_ts_init_conf_set,
    .mepa_driver_ts_mode_get               = vtss_ts_mode_get,
    .mepa_driver_ts_mode_set               = vtss_ts_mode_set,
    .mepa_driver_ts_ltc_ls_en              = vtss_ts_ltc_ls_en_set,
    .mepa_driver_ts_ltc_get                = vtss_ts_ltc_get,
    .mepa_driver_ts_ltc_set                = vtss_ts_ltc_set,
    .mepa_driver_ts_clock_rateadj_get      = vtss_ts_clock_rateadj_get,
    .mepa_driver_ts_clock_rateadj_set      = vtss_ts_clock_rateadj_set,
    .mepa_driver_ts_clock_adj1ns           = vtss_ts_clock_adj1ns,
    .mepa_driver_ts_delay_asymmetry_get    = vtss_ts_clock_delay_asymmetry_get,
    .mepa_driver_ts_delay_asymmetry_set    = vtss_ts_clock_delay_asymmetry_set,
    .mepa_driver_ts_path_delay_get         = vtss_ts_clock_path_delay_get,
    .mepa_driver_ts_path_delay_set         = vtss_ts_clock_path_delay_set,
    .mepa_driver_ts_egress_latency_get     = vtss_ts_clock_egress_latency_get,
    .mepa_driver_ts_egress_latency_set     = vtss_ts_clock_egress_latency_set,
    .mepa_driver_ts_ingress_latency_get    = vtss_ts_clock_ingress_latency_get,
    .mepa_driver_ts_ingress_latency_set    = vtss_ts_clock_ingress_latency_set,
    .mepa_driver_ts_rx_clock_conf_get      = phy_rx_clock_conf_get,
    .mepa_driver_ts_tx_clock_conf_get      = phy_tx_clock_conf_get,
    .mepa_driver_ts_rx_clock_conf_set      = vtss_ts_rx_clock_conf_set,
    .mepa_driver_ts_tx_clock_conf_set      = vtss_ts_tx_clock_conf_set,
    .mepa_driver_ts_pps_conf_get           = vtss_ts_pps_conf_get,
    .mepa_driver_ts_pps_conf_set           = vtss_ts_pps_conf_set,
    .mepa_driver_ts_stats_get              = vtss_ts_stats_get,
    .mepa_driver_ts_event_get              = vtss_ts_event_get,
    .mepa_driver_ts_event_set              = vtss_ts_event_set,
    .mepa_driver_ts_event_poll             = vtss_ts_event_poll,
    .mepa_driver_ts_rx_classifier_conf_set = phy_ts_rx_classifier_conf_set,
    .mepa_driver_ts_tx_classifier_conf_set = phy_ts_tx_classifier_conf_set,
    .mepa_driver_ts_rx_classifier_conf_get = phy_rx_classifier_conf_get,
    .mepa_driver_ts_tx_classifier_conf_get = phy_tx_classifier_conf_get,
    .mepa_driver_ts_fifo_read_install      = vtss_ts_fifo_read_install,
    .mepa_driver_ts_fifo_empty             = vtss_ts_fifo_empty,
    .mepa_driver_ts_fifo_get               = vtss_ts_fifo_get,
    .mepa_driver_ts_fifo_signature_set     = vtss_ts_fifo_signature_set,
    .mepa_driver_ts_fifo_signature_get     = vtss_ts_fifo_signature_get,
    .mepa_driver_ts_csr_reg_read           = vtss_phy_1588_csr_read,
    .mepa_driver_ts_csr_reg_write          = vtss_phy_1588_csr_write,
};
