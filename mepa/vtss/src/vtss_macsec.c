...
mepa_macsec_driver_t vtss_macsec_drivers = {
    .mepa_driver_macsec_init_set = vtss_phy_macsec_init_set,
    .mepa_driver_macsec_init_get = vtss_phy_macsec_init_get,
    .mepa_driver_macsec_secy_conf_add = vtss_phy_macsec_secy_conf_add,
    .mepa_driver_macsec_secy_conf_update = vtss_phy_macsec_secy_conf_update,
    .mepa_driver_macsec_secy_conf_get = vtss_phy_macsec_secy_conf_get,
    .mepa_driver_macsec_secy_conf_del = vtss_phy_macsec_secy_conf_del,
    .mepa_driver_macsec_secy_controlled_set = vtss_phy_macsec_secy_controlled_set,
    .mepa_driver_macsec_secy_controlled_get = vtss_phy_macsec_secy_controlled_get,
    .mepa_driver_macsec_secy_port_status_get = vtss_phy_macsec_secy_port_status_get,
    .mepa_driver_macsec_port_get_next = vtss_phy_macsec_port_get_next,
    .mepa_driver_macsec_rx_sc_add = vtss_phy_macsec_rx_sc_add,
    .mepa_driver_macsec_rx_sc_update = vtss_phy_macsec_rx_sc_update,
    .mepa_driver_macsec_rx_sc_get_conf = vtss_phy_macsec_rx_sc_get_conf,
    .mepa_driver_macsec_rx_sc_get_next = vtss_phy_macsec_rx_sc_get_next,
    .mepa_driver_macsec_rx_sc_del = vtss_phy_macsec_rx_sc_del,
    .mepa_driver_macsec_rx_sc_status_get = vtss_phy_macsec_rx_sc_status_get,
    .mepa_driver_macsec_tx_sc_set = vtss_phy_macsec_tx_sc_set,
    .mepa_driver_macsec_tx_sc_update = vtss_phy_macsec_tx_sc_update,
    .mepa_driver_macsec_tx_sc_get_conf = vtss_phy_macsec_tx_sc_get_conf,
    .mepa_driver_macsec_tx_sc_del = vtss_phy_macsec_tx_sc_del,
    .mepa_driver_macsec_tx_sc_status_get = vtss_phy_macsec_tx_sc_status_get,
    .mepa_driver_macsec_rx_sa_set = vtss_phy_macsec_rx_sa_set,
    .mepa_driver_macsec_rx_sa_get =  vtss_phy_macsec_rx_sa_get,
    .mepa_driver_macsec_rx_sa_activate = vtss_phy_macsec_rx_sa_activate,
    .mepa_driver_macsec_rx_sa_disable = vtss_phy_macsec_rx_sa_disable,
    .mepa_driver_macsec_rx_sa_del = vtss_phy_macsec_rx_sa_del,
    .mepa_driver_macsec_rx_sa_lowest_pn_update = vtss_phy_macsec_rx_sa_lowest_pn_update,
    .mepa_driver_macsec_rx_sa_status_get = vtss_phy_macsec_rx_sa_status_get,
    .mepa_driver_macsec_rx_seca_set = vtss_phy_macsec_rx_seca_set,
    .mepa_driver_macsec_rx_seca_get = vtss_phy_macsec_rx_seca_get,
    .mepa_driver_macsec_rx_seca_lowest_pn_update = vtss_phy_macsec_rx_seca_lowest_pn_update,
    .mepa_driver_macsec_tx_sa_set = vtss_phy_macsec_tx_sa_set,
    .mepa_driver_macsec_tx_sa_get = vtss_phy_macsec_tx_sa_get,
    .mepa_driver_macsec_tx_sa_activate = vtss_phy_macsec_tx_sa_activate,
    .mepa_driver_macsec_tx_sa_disable = vtss_phy_macsec_tx_sa_disable,
    .mepa_driver_macsec_tx_sa_del = vtss_phy_macsec_tx_sa_del,
    .mepa_driver_macsec_tx_sa_status_get = vtss_phy_macsec_tx_sa_status_get,
    .mepa_driver_macsec_tx_seca_set = vtss_phy_macsec_tx_seca_set,
    .mepa_driver_macsec_tx_seca_get = vtss_phy_macsec_tx_seca_get,
    .mepa_driver_macsec_controlled_counters_get = vtss_phy_macsec_controlled_counters_get,
    .mepa_driver_macsec_uncontrolled_counters_get = vtss_phy_macsec_uncontrolled_counters_get,
    .mepa_driver_macsec_common_counters_get = vtss_phy_macsec_common_counters_get,
    .mepa_driver_macsec_secy_cap_get = vtss_phy_macsec_secy_cap_get,
    .mepa_driver_macsec_secy_counters_get = vtss_phy_macsec_secy_counters_get,
    .mepa_driver_macsec_counters_update = vtss_phy_macsec_counters_update,
    .mepa_driver_macsec_counters_clear = vtss_phy_macsec_counters_clear,
    .mepa_driver_macsec_rx_sc_counters_get = vtss_phy_macsec_rx_sc_counters_get,
    .mepa_driver_macsec_tx_sc_counters_get = vtss_phy_macsec_tx_sc_counters_get,
    .mepa_driver_macsec_tx_sa_counters_get = vtss_phy_macsec_tx_sa_counters_get,
    .mepa_driver_macsec_rx_sa_counters_get = vtss_phy_macsec_rx_sa_counters_get,
    .mepa_driver_macsec_control_frame_match_conf_set = vtss_phy_macsec_control_frame_match_conf_set,
    .mepa_driver_macsec_control_frame_match_conf_del = vtss_phy_macsec_control_frame_match_conf_del,
    .mepa_driver_macsec_control_frame_match_conf_get = vtss_phy_macsec_control_frame_match_conf_get,
    .mepa_driver_macsec_pattern_set = vtss_phy_macsec_pattern_set,
    .mepa_driver_macsec_pattern_del = vtss_phy_macsec_pattern_del,
    .mepa_driver_macsec_pattern_get = vtss_phy_macsec_pattern_get,
    .mepa_driver_macsec_default_action_set = vtss_phy_macsec_default_action_set,
    .mepa_driver_macsec_default_action_get = vtss_phy_macsec_default_action_get,
    .mepa_driver_macsec_bypass_mode_set = vtss_phy_macsec_bypass_mode_set,
    .mepa_driver_macsec_bypass_mode_get = vtss_phy_macsec_bypass_mode_get,
    .mepa_driver_macsec_bypass_tag_set = vtss_phy_macsec_bypass_tag_set,
    .mepa_driver_macsec_bypass_tag_get = vtss_phy_macsec_bypass_tag_get,
    .mepa_driver_macsec_mtu_set = vtss_phy_macsec_mtu_set,
    .mepa_driver_macsec_mtu_get = vtss_phy_macsec_mtu_get,
    .mepa_driver_macsec_frame_capture_set = vtss_phy_macsec_frame_capture_set,
    .mepa_driver_macsec_frame_get = vtss_phy_macsec_frame_get,
    .mepa_driver_macsec_event_enable_set = vtss_phy_macsec_event_enable_set,
    .mepa_driver_macsec_event_enable_get = vtss_phy_macsec_event_enable_get,
    .mepa_driver_macsec_event_poll = vtss_phy_macsec_event_poll,
    .mepa_driver_macsec_event_seq_threshold_set = vtss_phy_macsec_event_seq_threshold_set,
    .mepa_driver_macsec_event_seq_threshold_get = vtss_phy_macsec_event_seq_threshold_get,
    .mepa_driver_macsec_egr_intr_sa_get = vtss_phy_macsec_egr_intr_sa_get,
    .mepa_driver_macsec_csr_read = vtss_phy_macsec_csr_read,
    .mepa_driver_macsec_csr_write = vtss_phy_macsec_csr_write,
    .mepa_driver_macsec_dbg_counter_get = vtss_phy_macsec_dbg_counter_get,
    .mepa_driver_macsec_hmac_counters_get = vtss_phy_macsec_hmac_counters_get,
    .mepa_driver_macsec_lmac_counters_get = vtss_phy_macsec_lmac_counters_get,
    .mepa_driver_macsec_is_capable = vtss_phy_macsec_is_capable,
    .mepa_driver_macsec_dbg_reg_dump = vtss_phy_macsec_dbg_reg_dump,
    .mepa_driver_macsec_inst_count_get = vtss_phy_macsec_inst_count_get,
    .mepa_driver_macsec_lmac_counters_clear = vtss_phy_macsec_lmac_counters_clear,
    .mepa_driver_macsec_hmac_counters_clear = vtss_phy_macsec_hmac_counters_clear,
    .mepa_driver_macsec_debug_counters_clear = vtss_phy_macsec_debug_counters_clear,
    .mepa_driver_macsec_common_counters_clear = vtss_phy_macsec_common_counters_clear,
    .mepa_driver_macsec_uncontrolled_counters_clear = vtss_phy_macsec_uncontrolled_counters_clear,
    .mepa_driver_macsec_controlled_counters_clear = vtss_phy_macsec_controlled_counters_clear,
    .mepa_driver_macsec_rxsa_counters_clear = vtss_phy_macsec_rxsa_counters_clear,
    .mepa_driver_macsec_rxsc_counters_clear = vtss_phy_macsec_rxsc_counters_clear,
    .mepa_driver_macsec_txsa_counters_clear = vtss_phy_macsec_txsa_counters_clear,
    .mepa_driver_macsec_txsc_counters_clear = vtss_phy_macsec_txsc_counters_clear,
    .mepa_driver_macsec_secy_counters_clear = vtss_phy_macsec_secy_counters_clear,
    .mepa_driver_macsec_port_enable_status_get = vtss_phy_macsec_port_enable_status_get,
    .mepa_driver_macsec_rxsa_an_status_get = vtss_phy_macsec_rxsa_an_status_get,
    .mepa_driver_mac_block_mtu_get = vtss_phy_mac_block_mtu_get,
    .mepa_driver_mac_block_mtu_set = vtss_phy_mac_block_mtu_set,
    .mepa_driver_macsec_fcbuf_frame_gap_comp_set = vtss_phy_macsec_fcbuf_frame_gap_comp_set,
    .mepa_driver_macsec_dbg_fcb_block_reg_dump = vtss_phy_macsec_dbg_fcb_block_reg_dump,
    .mepa_driver_macsec_dbg_frm_match_handling_ctrl_reg_dump = vtss_phy_macsec_dbg_frm_match_handling_ctrl_reg_dump,
#ifdef MEPA_MACSEC_FIFO_OVERFLOW_WORKAROUND
    .mepa_driver_macsec_dbg_reconfig = vtss_phy_macsec_dbg_reconfig,
#endif
    .mepa_driver_macsec_dbg_update_seq_set = vtss_phy_macsec_dbg_update_seq_set,
