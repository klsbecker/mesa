...
//! Field SI - Super Isolate
#define VSPEC1_PM_CTRL_SI_POS 12
//! Field SI - Super Isolate
#define VSPEC1_PM_CTRL_SI_MASK 0x1000u
//! Constant DISABLE - Disable (Normal Operation)
#define CONST_VSPEC1_PM_CTRL_SI_DISABLE 0x0
//! Constant ENABLE - Enable
#define CONST_VSPEC1_PM_CTRL_SI_ENABLE 0x1

//! Field DVS - DVS_DISABLE 
#define VSPEC1_PM_CTRL_DVS_DIS_POS 13
//! Field DVS - DVS_DISABLE 
#define VSPEC1_PM_CTRL_DVS_DIS_MASK 0x2000u
//! Constant DISABLE - Disable DVS
#define CONST_VSPEC1_PM_CTRL_DVS_DIS_DISABLE 0x1
//! Constant ENABLE - Enable DVS
#define CONST_VSPEC1_PM_CTRL_DVS_DIS_ENABLE 0x0
