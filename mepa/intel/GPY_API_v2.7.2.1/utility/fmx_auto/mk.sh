...
#LGM
export STAGING_DIR=/local/smanoharan/LGM/ugw_sw/openwrt/staging_dir
COMPILER_PREFIX=${STAGING_DIR}/toolchain-x86_64_gcc-11.2.0_musl/bin/x86_64-openwrt-linux-
#Falcon
