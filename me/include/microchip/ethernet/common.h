...
#define MESA_PHY_LINK_LOS_EV                ((uint32_t)1U << 0) /**< PHY link interrupt */
#define MESA_PHY_LINK_FFAIL_EV              ((uint32_t)1U << 1) /**< PHY fast failure interrupt */
#define MESA_PHY_LINK_AMS_EV                ((uint32_t)1U << 2) /**< PHY Automatic Media Sense */
#define MESA_PHY_LINK_SPEED_STATE_CHANGE_EV ((uint32_t)1U << 3) /**< PHY link state change event*/
#define MESA_PHY_LINK_FDX_STATE_CHANGE_EV   ((uint32_t)1U << 4) /**< PHY FDX state change event*/
#define MESA_PHY_LINK_AUTO_NEG_ERROR_EV     ((uint32_t)1U << 5) /**< PHY Autonegotiation error event*/
#define MESA_PHY_LINK_AUTO_NEG_COMPLETE_EV                                                         \
    ((uint32_t)1U << 6) /**< PHY Autonegotiation complete event*/
#define MESA_PHY_LINK_INLINE_POW_DEV_DETECT_EV                                                     \
    ((uint32_t)1U << 7) /**< PHY Inline powered device detect event */
#define MESA_PHY_LINK_SYMBOL_ERR_INT_EV ((uint32_t)1U << 8) /**< PHY Symbol error event */
#define MESA_PHY_LINK_TX_FIFO_OVERFLOW_INT_EV                                                      \
    ((uint32_t)1U << 9) /**< PHY TX fifo over/underflow detect event*/
#define MESA_PHY_LINK_RX_FIFO_OVERFLOW_INT_EV                                                      \
    ((uint32_t)1U << 10) /**< PHY RX fifo over/underflow detect event*/
#define MESA_PHY_LINK_FALSE_CARRIER_INT_EV                                                         \
    ((uint32_t)1U << 11) /**< PHY false-carrier interrupt event*/
#define MESA_PHY_LINK_LINK_SPEED_DS_DETECT_EV                                                      \
    ((uint32_t)1U << 12) /**< PHY Link speed downshift detect event*/
#define MESA_PHY_LINK_MASTER_SLAVE_RES_ERR_EV                                                      \
    ((uint32_t)1U << 13) /**< PHY master/salve resolution error event*/
#define MESA_PHY_LINK_RX_ER_INT_EV ((uint32_t)1U << 14) /**< PHY RX_ER interrupt event*/
#define MESA_PHY_LINK_EXTENDED_REG_INT_EV                                                          \
    ((uint32_t)1U << 15) /**< PHY Use Extended Reg to Access interrupt event*/
#define MESA_PHY_LINK_WAKE_ON_LAN_INT_EV ((uint32_t)1U << 16) /**< PHY Wake-On-LAN interrupt event*/
/* - Extended Events Defn
 * ------------------------------------------------------- */
#define MESA_PHY_LINK_EXT_EEE_WAKE_ERR_EV                                                          \
    ((uint32_t)1U << 17) /**< PHY EEE Wake Error interrupt event*/
#define MESA_PHY_LINK_EXT_EEE_WAIT_TS_EV                                                           \
    ((uint32_t)1U << 18) /**< PHY EEE Wait Quit/Rx TS Timer interrupt event*/
#define MESA_PHY_LINK_EXT_EEE_WAIT_RX_TQ_EV                                                        \
    ((uint32_t)1U << 19) /**< PHY EEE Rx TQ Timer interrupt event*/
#define MESA_PHY_LINK_EXT_EEE_LINKFAIL_EV                                                          \
    ((uint32_t)1U << 20) /**< PHY EEE Link Fail interrupt event*/
#define MESA_PHY_LINK_EXT_RR_SW_COMPL_EV                                                           \
    ((uint32_t)1U << 21) /**< PHY Ring Resiliancy Switchover complete interrupt event*/
#define MESA_PHY_LINK_EXT_MACSEC_HOST_MAC_EV                                                       \
    ((uint32_t)1U << 22) /**< PHY MACSEC Host MAC interrupt event*/
#define MESA_PHY_LINK_EXT_MACSEC_LINE_MAC_EV                                                       \
    ((uint32_t)1U << 23) /**< PHY MACSEC Line MAC interrupt event*/
#define MESA_PHY_LINK_EXT_MACSEC_FC_BUFF_EV                                                        \
    ((uint32_t)1U << 24) /**< PHY MACSEC Flow Control Buff interrupt event*/
#define MESA_PHY_LINK_EXT_MACSEC_INGRESS_EV                                                        \
    ((uint32_t)1U << 25) /**< PHY MACSEC Ingress interrupt event*/
